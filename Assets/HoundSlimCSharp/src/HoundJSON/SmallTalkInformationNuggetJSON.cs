        ...
        switch (chars[0])
          {
                                        ...
                                        switch (chars[6])
                                          {
                                            case 'A':
                                                ...
                                                break;
                                            case 'B':
                                                if ((String.Compare(chars, 7, "org", 0, 3, false) == 0) && (chars.Length == 10))
                                                    return TypeNormalizedQueryKnownValues.NormalizedQuery_AreYouBorg;
                                                break;
                                            case 'F':
                                                if ((String.Compare(chars, 7, "eeling", 0, 6, false) == 0) && (chars.Length == 13))
                                            ...
                                            case 'G':
                                                switch (chars[7])
                                                  {
                                                    case 'l':
                                                        ...
                                                        break;
                                                    case 'o':
                                                        if ((String.Compare(chars, 8, "odLooking", 0, 9, false) == 0) && (chars.Length == 17))
                                                ...
                                                break;
                                            case 'H':
                                                if ((String.Compare(chars, 7, "al", 0, 2, false) == 0) && (chars.Length == 9))
                                            ...
                                            case 'S':
                                                switch (chars[7])
                                                  {
                                                    case 'i':
                                                        if ((String.Compare(chars, 8, "ngle", 0, 4, false) == 0) && (chars.Length == 12))
                ...
                switch (chars[1])
                  {
                    case 'a':
                        ...
                        break;
                    case 'h':
                        if ((String.Compare(chars, 2, "ickenCrossRoad", 0, 14, false) == 0) && (chars.Length == 16))
                                        ...
                                        switch (chars[9])
                                          {
                                            ...
                                            case '_':
                                                switch (chars[10])
                                                  {
                                                    case 'E':
                                                        if ((String.Compare(chars, 11, "vening", 0, 6, false) == 0) && (chars.Length == 17))
            ...
            case 'H':
                switch (chars[1])
                  {
                    case 'a':
                        if ((String.Compare(chars, 2, "ppyBirthday", 0, 11, false) == 0) && (chars.Length == 13))
            ...
            case 'I':
                switch (chars[1])
                  {
                    case 'A':
                        if (String.Compare(chars, 2, "mYour", 0, 5, false) == 0)
                          {
                            switch (chars[7])
                              {
                                case 'F':
                ...
                switch (chars[1])
                  {
                    case 'a':
                        ...
                        break;
                    case 'e':
                        if (String.Compare(chars, 2, "aningOfLife_", 0, 12, false) == 0)
                          {
                            switch (chars[14])
                              {
                                case 'F':
                                ...
                                if (String.Compare(chars, 3, "t", 0, 1, false) == 0)
                                  {
                                    switch (chars[4])
                                      {
                                        case 'A':
                                            if ((String.Compare(chars, 5, "reYourInterests", 0, 15, false) == 0) && (chars.Length == 20))
                                        ...
                                        case 'C':
                                            ...
                                            break;
                                        case 'D':
                                            if (String.Compare(chars, 5, "oesThe", 0, 6, false) == 0)
                                              {
                                                switch (chars[11])
                                                  {
                                                    case 'C':
                                            ...
                                            break;
                                        case 'I':
                                            if (String.Compare(chars, 5, "sMy", 0, 3, false) == 0)
                                              {
                                                switch (chars[8])
                                                  {
                                                    case 'B':
                                    ...
                                    if (String.Compare(chars, 4, "re", 0, 2, false) == 0)
                                      {
                                        switch (chars[6])
                                          {
                                            case 'C':
                                                if ((String.Compare(chars, 7, "ute", 0, 3, false) == 0) && (chars.Length == 10))
        ...
        switch (json_string.getData()[0])
          {
                                        ...
                                        switch (json_string.getData()[6])
                                          {
                                            case 'A':
                                                ...
                                                break;
                                            case 'B':
                                                if ((String.Compare(json_string.getData(), 7, "org", 0, 3, false) == 0) && (json_string.getData().Length == 10))
                                                      {
                                                        the_open_enum.in_known_list = true;
                                                ...
                                                break;
                                            case 'F':
                                                if ((String.Compare(json_string.getData(), 7, "eeling", 0, 6, false) == 0) && (json_string.getData().Length == 13))
                                                      {
                                                        the_open_enum.in_known_list = true;
                                            ...
                                            case 'G':
                                                switch (json_string.getData()[7])
                                                  {
                                                    case 'l':
                                                        ...
                                                        break;
                                                    case 'o':
                                                        if ((String.Compare(json_string.getData(), 8, "odLooking", 0, 9, false) == 0) && (json_string.getData().Length == 17))
                                                              {
                                                                the_open_enum.in_known_list = true;
                                                ...
                                                break;
                                            case 'H':
                                                if ((String.Compare(json_string.getData(), 7, "al", 0, 2, false) == 0) && (json_string.getData().Length == 9))
                                                      {
                                                        the_open_enum.in_known_list = true;
                                            ...
                                            case 'S':
                                                switch (json_string.getData()[7])
                                                  {
                                                    case 'i':
                                                        if ((String.Compare(json_string.getData(), 8, "ngle", 0, 4, false) == 0) && (json_string.getData().Length == 12))
                                                              {
                                                                the_open_enum.in_known_list = true;
                ...
                switch (json_string.getData()[1])
                  {
                    case 'a':
                        ...
                        break;
                    case 'h':
                        if ((String.Compare(json_string.getData(), 2, "ickenCrossRoad", 0, 14, false) == 0) && (json_string.getData().Length == 16))
                              {
                                the_open_enum.in_known_list = true;
                                        ...
                                        switch (json_string.getData()[9])
                                          {
                                            ...
                                            case '_':
                                                switch (json_string.getData()[10])
                                                  {
                                                    case 'E':
                                                        if ((String.Compare(json_string.getData(), 11, "vening", 0, 6, false) == 0) && (json_string.getData().Length == 17))
                                                              {
                                                                the_open_enum.in_known_list = true;
            ...
            case 'H':
                switch (json_string.getData()[1])
                  {
                    case 'a':
                        if ((String.Compare(json_string.getData(), 2, "ppyBirthday", 0, 11, false) == 0) && (json_string.getData().Length == 13))
                              {
                                the_open_enum.in_known_list = true;
            ...
            case 'I':
                switch (json_string.getData()[1])
                  {
                    case 'A':
                        if (String.Compare(json_string.getData(), 2, "mYour", 0, 5, false) == 0)
                          {
                            switch (json_string.getData()[7])
                              {
                                case 'F':
                ...
                switch (json_string.getData()[1])
                  {
                    case 'a':
                        ...
                        break;
                    case 'e':
                        if (String.Compare(json_string.getData(), 2, "aningOfLife_", 0, 12, false) == 0)
                          {
                            switch (json_string.getData()[14])
                              {
                                case 'F':
                                ...
                                if (String.Compare(json_string.getData(), 3, "t", 0, 1, false) == 0)
                                  {
                                    switch (json_string.getData()[4])
                                      {
                                        case 'A':
                                            if ((String.Compare(json_string.getData(), 5, "reYourInterests", 0, 15, false) == 0) && (json_string.getData().Length == 20))
                                                  {
                                                    the_open_enum.in_known_list = true;
                                        ...
                                        case 'C':
                                            ...
                                            break;
                                        case 'D':
                                            if (String.Compare(json_string.getData(), 5, "oesThe", 0, 6, false) == 0)
                                              {
                                                switch (json_string.getData()[11])
                                                  {
                                                    case 'C':
                                            ...
                                            break;
                                        case 'I':
                                            if (String.Compare(json_string.getData(), 5, "sMy", 0, 3, false) == 0)
                                              {
                                                switch (json_string.getData()[8])
                                                  {
                                                    case 'B':
                                    ...
                                    if (String.Compare(json_string.getData(), 4, "re", 0, 2, false) == 0)
                                      {
                                        switch (json_string.getData()[6])
                                          {
                                            case 'C':
                                                if ((String.Compare(json_string.getData(), 7, "ute", 0, 3, false) == 0) && (json_string.getData().Length == 10))
                                                      {
                                                        the_open_enum.in_known_list = true;
