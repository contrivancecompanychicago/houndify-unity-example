/* file "SportsOlympicsMedalStandingsArgumentHostJSON.cs" */
...
public class SportsOlympicsMedalStandingsArgumentHostJSON : SportsOlympicsMedalStandingsArgumentJSON
  {
    ...
    private void  fromJSONHosts(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Hosts of SportsOlympicsMedalStandingsArgumentHostJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Hosts of SportsOlympicsMedalStandingsArgumentHostJSON has too few elements.");
    ...
    public SportsOlympicsMedalStandingsArgumentHostJSON()
      {
        flagHasHosts = false;
    ...
    public virtual int extraSportsOlympicsMedalStandingsArgumentHostComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsOlympicsMedalStandingsArgumentHostComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsOlympicsMedalStandingsArgumentHostComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsOlympicsMedalStandingsArgumentHostLookup(string field_name)
      {
    ...
    public virtual void extraSportsOlympicsMedalStandingsArgumentHostAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsOlympicsMedalStandingsArgumentHostSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new SportsOlympicsMedalStandingsArgumentHostJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsMedalStandingsArgumentHostJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentHost", ignore_extras);
    ...
    public static new SportsOlympicsMedalStandingsArgumentHostJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsMedalStandingsArgumentHostJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsMedalStandingsArgumentHostJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentHost", ignore_extras);
    ...
    public static new SportsOlympicsMedalStandingsArgumentHostJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsMedalStandingsArgumentHostJSON from_text(string text, bool ignore_extras)
      {
        SportsOlympicsMedalStandingsArgumentHostJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentHost", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsOlympicsMedalStandingsArgumentHostJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsOlympicsMedalStandingsArgumentHostJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsOlympicsMedalStandingsArgumentHostJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentHost", ignore_extras);
    ...
    public new abstract class Generator : SportsOlympicsMedalStandingsArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsOlympicsMedalStandingsArgumentJSONKey().Equals("Host")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsOlympicsMedalStandingsArgumentHostAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsOlympicsMedalStandingsArgumentHostJSON result)
          {
        ...
        protected abstract void handle_result(SportsOlympicsMedalStandingsArgumentHostJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorHosts = new SportsOlympicsGamesCodeJSON.HoldingArrayGenerator("field \"Hosts\" of the SportsOlympicsMedalStandingsArgumentHost class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SportsOlympicsMedalStandingsArgumentHost class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorHosts = new SportsOlympicsGamesCodeJSON.HoldingArrayGenerator("field \"Hosts\" of the SportsOlympicsMedalStandingsArgumentHost class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsOlympicsMedalStandingsArgumentHostJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsOlympicsMedalStandingsArgumentHostJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsOlympicsMedalStandingsArgumentHostJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsOlympicsMedalStandingsArgumentHostJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsOlympicsMedalStandingsArgumentHostJSON> value;
  };
  };
