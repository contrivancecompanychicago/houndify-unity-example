/* file "SportsLeaguesResponseStateJSON.cs" */
...
public class SportsLeaguesResponseStateJSON : JSONBase
  {
    ...
    public SportsLeaguesResponseStateJSON()
      {
    ...
    public virtual int extraSportsLeaguesResponseStateComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsLeaguesResponseStateComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsLeaguesResponseStateComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsLeaguesResponseStateLookup(string field_name)
      {
    ...
    public virtual void extraSportsLeaguesResponseStateAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsLeaguesResponseStateSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static SportsLeaguesResponseStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsLeaguesResponseStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsLeaguesResponseState", ignore_extras);
    ...
    public static SportsLeaguesResponseStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsLeaguesResponseStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsLeaguesResponseStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsLeaguesResponseState", ignore_extras);
    ...
    public static SportsLeaguesResponseStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsLeaguesResponseStateJSON from_text(string text, bool ignore_extras)
      {
        SportsLeaguesResponseStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsLeaguesResponseState", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsLeaguesResponseStateJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static SportsLeaguesResponseStateJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsLeaguesResponseStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsLeaguesResponseState", ignore_extras);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsLeaguesResponseStateAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsLeaguesResponseStateJSON result)
          {
        ...
        protected abstract void handle_result(SportsLeaguesResponseStateJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorLeagues = new SportsLeagueCodeJSON.HoldingArrayGenerator("field \"Leagues\" of the SportsLeaguesResponseState class", ignore_extras);
        ...
        public Generator()
          {
            fieldGeneratorLeagues = new SportsLeagueCodeJSON.HoldingArrayGenerator("field \"Leagues\" of the SportsLeaguesResponseState class", false);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsLeaguesResponseStateJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsLeaguesResponseStateJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsLeaguesResponseStateJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsLeaguesResponseStateJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsLeaguesResponseStateJSON> value;
  };
  };
