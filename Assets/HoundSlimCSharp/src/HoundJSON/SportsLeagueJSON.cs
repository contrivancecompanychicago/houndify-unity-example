                    ...
                    switch (chars[6])
                      {
                        ...
                        case 'F':
                            ...
                            break;
                        case 'I':
                            if ((String.Compare(chars, 7, "nternational", 0, 12, false) == 0) && (chars.Length == 19))
                    ...
                    switch (json_string.getData()[6])
                      {
                        ...
                        case 'F':
                            ...
                            break;
                        case 'I':
                            if ((String.Compare(json_string.getData(), 7, "nternational", 0, 12, false) == 0) && (json_string.getData().Length == 19))
                                  {
                                    the_open_enum.in_known_list = true;
