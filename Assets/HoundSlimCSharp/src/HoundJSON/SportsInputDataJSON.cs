...
public class SportsInputDataJSON : JSONBase
  {
    ...
    public enum TypeSportsGroupKnownValues
      {
        SportsGroup_MLB,
        SportsGroup_NBA,
        SportsGroup_NFL,
    ...
    public struct TypeSportsGroup
      {
        public bool in_known_list;
        public string string_value;
        public TypeSportsGroupKnownValues list_value;
      };

    public static TypeSportsGroupKnownValues  stringToSportsGroup(string chars)
      {
        switch (chars[0])
          {
            case 'B':
                if ((String.Compare(chars, 1, "asketball", 0, 9, false) == 0) && (chars.Length == 10))
                    return TypeSportsGroupKnownValues.SportsGroup_Basketball;
                break;
            case 'C':
                if ((String.Compare(chars, 1, "FL", 0, 2, false) == 0) && (chars.Length == 3))
                    return TypeSportsGroupKnownValues.SportsGroup_CFL;
                break;
            case 'F':
                if ((String.Compare(chars, 1, "ootball", 0, 7, false) == 0) && (chars.Length == 8))
                    return TypeSportsGroupKnownValues.SportsGroup_Football;
                break;
            case 'M':
                    ...
                    switch (chars[2])
                      {
                        case 'B':
                            if (chars.Length == 3)
                                return TypeSportsGroupKnownValues.SportsGroup_MLB;
                            break;
                        case 'S':
                            if (chars.Length == 3)
                                return TypeSportsGroupKnownValues.SportsGroup_MLS;
                            break;
                        default:
                            break;
                      }
                ...
                switch (chars[1])
                  {
                    case 'B':
                        if ((String.Compare(chars, 2, "A", 0, 1, false) == 0) && (chars.Length == 3))
                            return TypeSportsGroupKnownValues.SportsGroup_NBA;
                        break;
                    case 'C':
                        if (String.Compare(chars, 2, "AA", 0, 2, false) == 0)
                          {
                            if (chars.Length == 4)
                              {
                                return TypeSportsGroupKnownValues.SportsGroup_NCAA;
                              }
                            switch (chars[4])
                              {
                                case 'F':
                                    if ((String.Compare(chars, 5, "B", 0, 1, false) == 0) && (chars.Length == 6))
                                        return TypeSportsGroupKnownValues.SportsGroup_NCAAFB;
                                    break;
                                case 'M':
                                    if ((String.Compare(chars, 5, "B", 0, 1, false) == 0) && (chars.Length == 6))
                                        return TypeSportsGroupKnownValues.SportsGroup_NCAAMB;
                                    break;
                                default:
                                    break;
                              }
                    ...
                    case 'F':
                        if ((String.Compare(chars, 2, "L", 0, 1, false) == 0) && (chars.Length == 3))
                            return TypeSportsGroupKnownValues.SportsGroup_NFL;
                        break;
                    case 'H':
                        if ((String.Compare(chars, 2, "L", 0, 1, false) == 0) && (chars.Length == 3))
                            return TypeSportsGroupKnownValues.SportsGroup_NHL;
                        break;
                    default:
                        break;
                  }
                ...
                if (String.Compare(chars, 1, "occer", 0, 5, false) == 0)
                  {
                    if (chars.Length == 6)
                      {
                        return TypeSportsGroupKnownValues.SportsGroup_Soccer;
                      }
                    switch (chars[6])
                      {
                        case 'B':
                            if ((String.Compare(chars, 7, "undesliga", 0, 9, false) == 0) && (chars.Length == 16))
                                return TypeSportsGroupKnownValues.SportsGroup_SoccerBundesliga;
                            break;
                        case 'E':
                            switch (chars[7])
                              {
                                case 'r':
                                    if ((String.Compare(chars, 8, "edivisie", 0, 8, false) == 0) && (chars.Length == 16))
                                        return TypeSportsGroupKnownValues.SportsGroup_SoccerEredivisie;
                                    break;
                                case 'u':
                                    if ((String.Compare(chars, 8, "ropaLeague", 0, 10, false) == 0) && (chars.Length == 18))
                                        return TypeSportsGroupKnownValues.SportsGroup_SoccerEuropaLeague;
                                    break;
                                default:
                                    break;
                              }
                        ...
                        case 'F':
                            switch (chars[7])
                              {
                                case 'i':
                                    if ((String.Compare(chars, 8, "rstDivisionA", 0, 12, false) == 0) && (chars.Length == 20))
                                        return TypeSportsGroupKnownValues.SportsGroup_SoccerFirstDivisionA;
                                    break;
                                case 'o':
                                    if ((String.Compare(chars, 8, "otball", 0, 6, false) == 0) && (chars.Length == 14))
                                        return TypeSportsGroupKnownValues.SportsGroup_SoccerFootball;
                                    break;
                                default:
                                    break;
                              }
                        ...
                        case 'L':
                            if ((String.Compare(chars, 7, "igue1", 0, 5, false) == 0) && (chars.Length == 12))
                                return TypeSportsGroupKnownValues.SportsGroup_SoccerLigue1;
                            break;
                        case 'P':
                                        ...
                                        if (String.Compare(chars, 9, "mierLeague", 0, 10, false) == 0)
                                          {
                                            if (chars.Length == 19)
                                              {
                                                return TypeSportsGroupKnownValues.SportsGroup_SoccerPremierLeague;
                                              }
                                            switch (chars[19])
                                              {
                                                case 'R':
                                                    if ((String.Compare(chars, 20, "US", 0, 2, false) == 0) && (chars.Length == 22))
                                                        return TypeSportsGroupKnownValues.SportsGroup_SoccerPremierLeagueRUS;
                                                    break;
                                                case 'U':
                                                    if ((String.Compare(chars, 20, "KR", 0, 2, false) == 0) && (chars.Length == 22))
                                                        return TypeSportsGroupKnownValues.SportsGroup_SoccerPremierLeagueUKR;
                                                    break;
                                                default:
                                                    break;
                                              }
                                            ...
                                            switch (chars[11])
                                              {
                                                case 'i':
                                                    if ((String.Compare(chars, 12, "raLiga", 0, 6, false) == 0) && (chars.Length == 18))
                                                        return TypeSportsGroupKnownValues.SportsGroup_SoccerPrimeiraLiga;
                                                    break;
                                                case 'r':
                                                    if ((String.Compare(chars, 12, "aDivision", 0, 9, false) == 0) && (chars.Length == 21))
                                                        return TypeSportsGroupKnownValues.SportsGroup_SoccerPrimeraDivision;
                                                    break;
                                                default:
                                                    break;
                                              }
                            ...
                            switch (chars[7])
                              {
                                case 'e':
                                    if ((String.Compare(chars, 8, "rieA", 0, 4, false) == 0) && (chars.Length == 12))
                                        return TypeSportsGroupKnownValues.SportsGroup_SoccerSerieA;
                                    break;
                                case 'u':
                                        ...
                                        switch (chars[12])
                                          {
                                            case 'e':
                                                if ((String.Compare(chars, 13, "ague", 0, 4, false) == 0) && (chars.Length == 17))
                                                    return TypeSportsGroupKnownValues.SportsGroup_SoccerSuperLeague;
                                                break;
                                            case 'i':
                                                if ((String.Compare(chars, 13, "g", 0, 1, false) == 0) && (chars.Length == 14))
                                                    return TypeSportsGroupKnownValues.SportsGroup_SoccerSuperLig;
                                                break;
                                            default:
                                                break;
                                          }
                                ...
                                switch (chars[10])
                                  {
                                    case 'C':
                                        if ((String.Compare(chars, 11, "hampionsLeague", 0, 14, false) == 0) && (chars.Length == 25))
                                            return TypeSportsGroupKnownValues.SportsGroup_SoccerUEFAChampionsLeague;
                                        break;
                                    case 'S':
                                        if ((String.Compare(chars, 11, "uperCup", 0, 7, false) == 0) && (chars.Length == 18))
                                            return TypeSportsGroupKnownValues.SportsGroup_SoccerUEFASuperCup;
                                        break;
                                    default:
                                        break;
                                  }
                        ...
                        case 'Y':
                            if ((String.Compare(chars, 7, "outhLeague", 0, 10, false) == 0) && (chars.Length == 17))
                                return TypeSportsGroupKnownValues.SportsGroup_SoccerYouthLeague;
                            break;
                        default:
                            break;
                      }
        ...
        return TypeSportsGroupKnownValues.SportsGroup__none;
      }

    public static string  stringFromSportsGroup(TypeSportsGroupKnownValues the_enum)
      {
        switch (the_enum)
          {
            case TypeSportsGroupKnownValues.SportsGroup_MLB:
                return "MLB";
            case TypeSportsGroupKnownValues.SportsGroup_NBA:
                return "NBA";
            case TypeSportsGroupKnownValues.SportsGroup_NFL:
                return "NFL";
            case TypeSportsGroupKnownValues.SportsGroup_NHL:
                return "NHL";
            case TypeSportsGroupKnownValues.SportsGroup_NCAAMB:
                return "NCAAMB";
            case TypeSportsGroupKnownValues.SportsGroup_NCAAFB:
                return "NCAAFB";
            case TypeSportsGroupKnownValues.SportsGroup_Basketball:
                return "Basketball";
            case TypeSportsGroupKnownValues.SportsGroup_Football:
                return "Football";
            case TypeSportsGroupKnownValues.SportsGroup_NCAA:
                return "NCAA";
            case TypeSportsGroupKnownValues.SportsGroup_Soccer:
                return "Soccer";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerFootball:
                return "SoccerFootball";
            case TypeSportsGroupKnownValues.SportsGroup_MLS:
                return "MLS";
            case TypeSportsGroupKnownValues.SportsGroup_CFL:
                return "CFL";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerUEFAChampionsLeague:
                return "SoccerUEFAChampionsLeague";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerPrimeraDivision:
                return "SoccerPrimeraDivision";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerPremierLeague:
                return "SoccerPremierLeague";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerSerieA:
                return "SoccerSerieA";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerLigue1:
                return "SoccerLigue1";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerBundesliga:
                return "SoccerBundesliga";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerEredivisie:
                return "SoccerEredivisie";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerFirstDivisionA:
                return "SoccerFirstDivisionA";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerSuperLig:
                return "SoccerSuperLig";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerSuperLeague:
                return "SoccerSuperLeague";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerPremierLeagueRUS:
                return "SoccerPremierLeagueRUS";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerPremierLeagueUKR:
                return "SoccerPremierLeagueUKR";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerPrimeiraLiga:
                return "SoccerPrimeiraLiga";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerUEFASuperCup:
                return "SoccerUEFASuperCup";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerEuropaLeague:
                return "SoccerEuropaLeague";
            case TypeSportsGroupKnownValues.SportsGroup_SoccerYouthLeague:
    ...
    private bool flagHasSportsGroup;
    private TypeSportsGroup storeSportsGroup;
    ...
    private void  fromJSONSportsGroup(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SportsGroup of SportsInputDataJSON is not a string.");
        TypeSportsGroup the_open_enum = new TypeSportsGroup();
        switch (json_string.getData()[0])
          {
            case 'B':
                if ((String.Compare(json_string.getData(), 1, "asketball", 0, 9, false) == 0) && (json_string.getData().Length == 10))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_Basketball;
                        goto open_enum_is_done;
                      }
                break;
            case 'C':
                if ((String.Compare(json_string.getData(), 1, "FL", 0, 2, false) == 0) && (json_string.getData().Length == 3))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_CFL;
                        goto open_enum_is_done;
                      }
                break;
            case 'F':
                if ((String.Compare(json_string.getData(), 1, "ootball", 0, 7, false) == 0) && (json_string.getData().Length == 8))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_Football;
                        goto open_enum_is_done;
                      }
                break;
            case 'M':
                    ...
                    switch (json_string.getData()[2])
                      {
                        case 'B':
                            if (json_string.getData().Length == 3)
                                  {
                                    the_open_enum.in_known_list = true;
                                    the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_MLB;
                                    goto open_enum_is_done;
                                  }
                            break;
                        case 'S':
                            if (json_string.getData().Length == 3)
                                  {
                                    the_open_enum.in_known_list = true;
                                    the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_MLS;
                                    goto open_enum_is_done;
                                  }
                            break;
                        default:
                ...
                switch (json_string.getData()[1])
                  {
                    case 'B':
                        if ((String.Compare(json_string.getData(), 2, "A", 0, 1, false) == 0) && (json_string.getData().Length == 3))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_NBA;
                                goto open_enum_is_done;
                              }
                        break;
                    case 'C':
                            ...
                            if (json_string.getData().Length == 4)
                              {
                                  {
                                    the_open_enum.in_known_list = true;
                                    the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_NCAA;
                                    goto open_enum_is_done;
                                  }
                              }
                            switch (json_string.getData()[4])
                              {
                                case 'F':
                                    if ((String.Compare(json_string.getData(), 5, "B", 0, 1, false) == 0) && (json_string.getData().Length == 6))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_NCAAFB;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                case 'M':
                                    if ((String.Compare(json_string.getData(), 5, "B", 0, 1, false) == 0) && (json_string.getData().Length == 6))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_NCAAMB;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                default:
                    ...
                    case 'F':
                        if ((String.Compare(json_string.getData(), 2, "L", 0, 1, false) == 0) && (json_string.getData().Length == 3))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_NFL;
                                goto open_enum_is_done;
                              }
                        break;
                    case 'H':
                        if ((String.Compare(json_string.getData(), 2, "L", 0, 1, false) == 0) && (json_string.getData().Length == 3))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_NHL;
                                goto open_enum_is_done;
                              }
                        break;
                    default:
                ...
                if (String.Compare(json_string.getData(), 1, "occer", 0, 5, false) == 0)
                  {
                    if (json_string.getData().Length == 6)
                      {
                          {
                            the_open_enum.in_known_list = true;
                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_Soccer;
                            goto open_enum_is_done;
                          }
                      }
                    switch (json_string.getData()[6])
                      {
                        case 'B':
                            if ((String.Compare(json_string.getData(), 7, "undesliga", 0, 9, false) == 0) && (json_string.getData().Length == 16))
                                  {
                                    the_open_enum.in_known_list = true;
                                    the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerBundesliga;
                                    goto open_enum_is_done;
                                  }
                            break;
                        case 'E':
                            switch (json_string.getData()[7])
                              {
                                case 'r':
                                    if ((String.Compare(json_string.getData(), 8, "edivisie", 0, 8, false) == 0) && (json_string.getData().Length == 16))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerEredivisie;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                case 'u':
                                    if ((String.Compare(json_string.getData(), 8, "ropaLeague", 0, 10, false) == 0) && (json_string.getData().Length == 18))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerEuropaLeague;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                default:
                        ...
                        case 'F':
                            switch (json_string.getData()[7])
                              {
                                case 'i':
                                    if ((String.Compare(json_string.getData(), 8, "rstDivisionA", 0, 12, false) == 0) && (json_string.getData().Length == 20))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerFirstDivisionA;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                case 'o':
                                    if ((String.Compare(json_string.getData(), 8, "otball", 0, 6, false) == 0) && (json_string.getData().Length == 14))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerFootball;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                default:
                        ...
                        case 'L':
                            if ((String.Compare(json_string.getData(), 7, "igue1", 0, 5, false) == 0) && (json_string.getData().Length == 12))
                                  {
                                    the_open_enum.in_known_list = true;
                                    the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerLigue1;
                                    goto open_enum_is_done;
                                  }
                            break;
                        case 'P':
                                            ...
                                            if (json_string.getData().Length == 19)
                                              {
                                                  {
                                                    the_open_enum.in_known_list = true;
                                                    the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerPremierLeague;
                                                    goto open_enum_is_done;
                                                  }
                                              }
                                            switch (json_string.getData()[19])
                                              {
                                                case 'R':
                                                    if ((String.Compare(json_string.getData(), 20, "US", 0, 2, false) == 0) && (json_string.getData().Length == 22))
                                                          {
                                                            the_open_enum.in_known_list = true;
                                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerPremierLeagueRUS;
                                                            goto open_enum_is_done;
                                                          }
                                                    break;
                                                case 'U':
                                                    if ((String.Compare(json_string.getData(), 20, "KR", 0, 2, false) == 0) && (json_string.getData().Length == 22))
                                                          {
                                                            the_open_enum.in_known_list = true;
                                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerPremierLeagueUKR;
                                                            goto open_enum_is_done;
                                                          }
                                                    break;
                                                default:
                                            ...
                                            switch (json_string.getData()[11])
                                              {
                                                case 'i':
                                                    if ((String.Compare(json_string.getData(), 12, "raLiga", 0, 6, false) == 0) && (json_string.getData().Length == 18))
                                                          {
                                                            the_open_enum.in_known_list = true;
                                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerPrimeiraLiga;
                                                            goto open_enum_is_done;
                                                          }
                                                    break;
                                                case 'r':
                                                    if ((String.Compare(json_string.getData(), 12, "aDivision", 0, 9, false) == 0) && (json_string.getData().Length == 21))
                                                          {
                                                            the_open_enum.in_known_list = true;
                                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerPrimeraDivision;
                                                            goto open_enum_is_done;
                                                          }
                                                    break;
                                                default:
                            ...
                            switch (json_string.getData()[7])
                              {
                                case 'e':
                                    if ((String.Compare(json_string.getData(), 8, "rieA", 0, 4, false) == 0) && (json_string.getData().Length == 12))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerSerieA;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                case 'u':
                                        ...
                                        switch (json_string.getData()[12])
                                          {
                                            case 'e':
                                                if ((String.Compare(json_string.getData(), 13, "ague", 0, 4, false) == 0) && (json_string.getData().Length == 17))
                                                      {
                                                        the_open_enum.in_known_list = true;
                                                        the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerSuperLeague;
                                                        goto open_enum_is_done;
                                                      }
                                                break;
                                            case 'i':
                                                if ((String.Compare(json_string.getData(), 13, "g", 0, 1, false) == 0) && (json_string.getData().Length == 14))
                                                      {
                                                        the_open_enum.in_known_list = true;
                                                        the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerSuperLig;
                                                        goto open_enum_is_done;
                                                      }
                                                break;
                                            default:
                                ...
                                switch (json_string.getData()[10])
                                  {
                                    case 'C':
                                        if ((String.Compare(json_string.getData(), 11, "hampionsLeague", 0, 14, false) == 0) && (json_string.getData().Length == 25))
                                              {
                                                the_open_enum.in_known_list = true;
                                                the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerUEFAChampionsLeague;
                                                goto open_enum_is_done;
                                              }
                                        break;
                                    case 'S':
                                        if ((String.Compare(json_string.getData(), 11, "uperCup", 0, 7, false) == 0) && (json_string.getData().Length == 18))
                                              {
                                                the_open_enum.in_known_list = true;
                                                the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerUEFASuperCup;
                                                goto open_enum_is_done;
                                              }
                                        break;
                                    default:
                        ...
                        case 'Y':
                            if ((String.Compare(json_string.getData(), 7, "outhLeague", 0, 10, false) == 0) && (json_string.getData().Length == 17))
                                  {
                                    the_open_enum.in_known_list = true;
                                    the_open_enum.list_value = TypeSportsGroupKnownValues.SportsGroup_SoccerYouthLeague;
                                    goto open_enum_is_done;
                                  }
                            break;
                        default:
    ...
    public bool  hasSportsGroup()
      {
        return flagHasSportsGroup;
      }

    public TypeSportsGroup  getSportsGroup()
      {
        Debug.Assert(flagHasSportsGroup);
        return storeSportsGroup;
      }

    public string  getSportsGroupAsString()
      {
    ...
    public void setSportsGroup(TypeSportsGroup new_value)
      {
        flagHasSportsGroup = true;
        storeSportsGroup = new_value;
      }
    public void setSportsGroup(string chars)
      {
        TypeSportsGroupKnownValues known = stringToSportsGroup(chars);
        TypeSportsGroup new_value = new TypeSportsGroup();
        if (known == TypeSportsGroupKnownValues.SportsGroup__none)
          {
            new_value.in_known_list = false;
            new_value.string_value = chars;
          }
    ...
    public void setSportsGroup(TypeSportsGroupKnownValues new_value)
      {
        TypeSportsGroup new_full_value = new TypeSportsGroup();
        Debug.Assert(new_value != TypeSportsGroupKnownValues.SportsGroup__none);
        new_full_value.in_known_list = true;
        new_full_value.list_value = new_value;
        setSportsGroup(new_full_value);
      }
    public void unsetSportsGroup()
      {
        flagHasSportsGroup = false;
      }
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorQueryType : JSONArrayGenerator
  {
    ...
    private abstract class FieldGeneratorSportsGroup : JSONStringGenerator
          {
            protected FieldGeneratorSportsGroup(string what)
              {
                set_what(what);
              }
            protected FieldGeneratorSportsGroup()
              {
              }
            protected override void handle_result(string result)
              {
            ...
            protected abstract void handle_result(TypeSportsGroup result);
          };
    private class FieldHoldingGeneratorSportsGroup : FieldGeneratorSportsGroup
  {
    protected override void handle_result(TypeSportsGroup result)
      {
//@@@        Debug.Assert(!have_value);
        have_value = true;
        value = result;
    ...
    public FieldHoldingGeneratorSportsGroup(String what)
      {
        have_value = false;
        base.set_what(what);
      }
    ...
    public bool have_value;
    public TypeSportsGroup value;
  };
    private class FieldHoldingArrayGeneratorSportsGroup : JSONArrayGenerator
  {
    protected class ElementHandler : FieldGeneratorSportsGroup
      {
        private FieldHoldingArrayGeneratorSportsGroup top;
        ...
        public ElementHandler(FieldHoldingArrayGeneratorSportsGroup init_top)
          {
            top = init_top;
          }
      };
    ...
    protected virtual void handle_result(List<TypeSportsGroup> result)
      {
      }

    public FieldHoldingArrayGeneratorSportsGroup(string what)
      {
        element_handler = new ElementHandler(this);
        have_value = false;
        value = new List<TypeSportsGroup>();
        base.set_what(what);
      }
    public FieldHoldingArrayGeneratorSportsGroup()
      {
        element_handler = new ElementHandler(this);
        have_value = false;
        value = new List<TypeSportsGroup>();
    ...
    public bool have_value;
    public List<TypeSportsGroup> value;
  };
        private FieldHoldingGeneratorSportsGroup fieldGeneratorSportsGroup;
                    ...
                    switch (field_name[1])
                      {
                        case 'e':
                            ...
                            break;
                        case 'p':
                            if ((String.Compare(field_name, 2, "ortsGroup", 0, 9, false) == 0) && (field_name.Length == 11))
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorSportsGroup = new FieldHoldingGeneratorSportsGroup("field \"SportsGroup\" of the SportsInputData class");
