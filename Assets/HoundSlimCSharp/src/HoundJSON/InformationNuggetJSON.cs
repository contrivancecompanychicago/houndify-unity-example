    ...
    switch (key[0])
      {
            ...
            switch (key[1])
              {
                case 'l':
                    ...
                    break;
                case 'r':
                    if ((String.Compare(key, 2, "eaCodeInfoNugget", 0, 16, false) == 0) && (key.Length == 18))
                      {
        ...
        case 'C':
            switch (key[1])
              {
                case 'h':
                    if ((String.Compare(key, 2, "ineseZodiacInfoNugget", 0, 21, false) == 0) && (key.Length == 23))
                      {
                    ...
                    switch (key[2])
                      {
                        case 'c':
                            ...
                            break;
                        case 's':
                            if ((String.Compare(key, 3, "playMap", 0, 7, false) == 0) && (key.Length == 10))
                                return new DisplayMapInformationNuggetJSON();
                            break;
                        default:
                            break;
                      }
                    ...
                    switch (key[2])
                      {
                        case 'n':
                            ...
                            break;
                        case 'o':
                            if ((String.Compare(key, 3, "nameFacts", 0, 9, false) == 0) && (key.Length == 12))
        ...
        case 'H':
            switch (key[1])
              {
                case 'a':
                    ...
                    break;
                case 'o':
                    if (String.Compare(key, 2, "tel", 0, 3, false) == 0)
                      {
                        if (key.Length == 5)
                          {
            ...
            break;
        case 'L':
            if ((String.Compare(key, 1, "ocalSearch", 0, 10, false) == 0) && (key.Length == 11))
        ...
        case 'M':
            switch (key[1])
              {
                case 'a':
                    ...
                    break;
                case 'u':
                    if ((String.Compare(key, 2, "sic", 0, 3, false) == 0) && (key.Length == 5))
                      {
            ...
            break;
        case 'N':
            if (String.Compare(key, 1, "u", 0, 1, false) == 0)
              {
                switch (key[2])
                  {
                    case 'm':
                        if ((String.Compare(key, 3, "berGuess", 0, 8, false) == 0) && (key.Length == 11))
                          {
            ...
            switch (key[1])
              {
                case 'b':
                    ...
                    break;
                case 'n':
                    if ((String.Compare(key, 2, "itConverter", 0, 11, false) == 0) && (key.Length == 13))
        ...
        case 'W':
            switch (key[1])
              {
                case 'e':
                    if ((String.Compare(key, 2, "ather", 0, 5, false) == 0) && (key.Length == 7))
                      {
