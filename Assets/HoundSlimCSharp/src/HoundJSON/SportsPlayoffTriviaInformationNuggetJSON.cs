...
public class SportsPlayoffTriviaInformationNuggetJSON : SportsInformationNuggetJSON
  {
    ...
    private JSONValue  extraIsSingleGameToJSON()
      {
    ...
    private JSONValue  extraRankResultToJSON()
      {
        JSONIntegerValue generated_integer_RankResult = new JSONIntegerValue(storeRankResult);
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field IsSingleGame of SportsPlayoffTriviaInformationNuggetJSON is not true for false.");
              }
          }
        ...
        switch (field_name[0])
          {
            case 'G':
                ...
                break;
            case 'I':
                if ((String.Compare(field_name, 1, "sSingleGame", 0, 11, false) == 0) && (field_name.Length == 12))
    ...
    public void setRankResult(BigInteger new_value)
      {
        ...
        if (new_value < -1)
            throw new Exception("The value for field RankResult of SportsPlayoffTriviaInformationNuggetJSON is less than the lower bound (-1) for that field.");
        ...
        switch (key[0])
          {
            case 'G':
                ...
                break;
            case 'I':
                if ((String.Compare(key, 1, "sSingleGame", 0, 11, false) == 0) && (key.Length == 12))
                    {
            ...
            case 'Q':
                ...
                break;
            case 'R':
                if (String.Compare(key, 1, "ank", 0, 3, false) == 0)
                  {
                    switch (key[4])
                      {
                        case 'R':
                            if ((String.Compare(key, 5, "esult", 0, 5, false) == 0) && (key.Length == 10))
                                {
