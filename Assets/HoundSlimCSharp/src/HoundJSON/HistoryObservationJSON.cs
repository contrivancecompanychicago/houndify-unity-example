    ...
    private void  fromJSONConditionsShortPhrase(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field ConditionsShortPhrase of HistoryObservationJSON is not a string.");
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorConditionsShortPhrase = new JSONHoldingStringGenerator("field \"ConditionsShortPhrase\" of the HistoryObservation class");
            ...
            fieldGeneratorWind = new TypeWindJSON.HoldingGenerator("field \"Wind\" of the HistoryObservation class", ignore_extras);
            ...
            fieldGeneratorBarometricPressure = new TypeBarometricPressureJSON.HoldingGenerator("field \"BarometricPressure\" of the HistoryObservation class", ignore_extras);
        ...
        public Generator()
          {
            ...
            fieldGeneratorHumidityPct = new FieldHoldingGeneratorHumidityPct("field \"HumidityPct\" of the HistoryObservation class");
            fieldGeneratorWind = new TypeWindJSON.HoldingGenerator("field \"Wind\" of the HistoryObservation class", false);
            ...
            fieldGeneratorBarometricPressure = new TypeBarometricPressureJSON.HoldingGenerator("field \"BarometricPressure\" of the HistoryObservation class", false);
