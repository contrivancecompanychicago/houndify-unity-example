    ...
    public void setChannel(short new_value)
      {
        flagHasChannel = true;
        if (new_value < 530)
            throw new Exception("The value for field Channel of AMChannelCommandJSON is less than the lower bound (530) for that field.");
        if (new_value > 1710)
            throw new Exception("The value for field Channel of AMChannelCommandJSON is greater than the upper bound (1710) for that field.");
