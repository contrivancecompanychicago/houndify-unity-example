        ...
        switch (chars[0])
          {
            ...
            case 'N':
                ...
                break;
            case 'S':
                if ((String.Compare(chars, 1, "howDirections", 0, 13, false) == 0) && (chars.Length == 14))
        ...
        switch (json_string.getData()[0])
          {
            ...
            case 'N':
                ...
                break;
            case 'S':
                if ((String.Compare(json_string.getData(), 1, "howDirections", 0, 13, false) == 0) && (json_string.getData().Length == 14))
                      {
                        the_open_enum.in_known_list = true;
