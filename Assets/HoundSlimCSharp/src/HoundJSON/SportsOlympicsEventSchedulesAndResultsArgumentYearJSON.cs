/* file "SportsOlympicsEventSchedulesAndResultsArgumentYearJSON.cs" */
...
public class SportsOlympicsEventSchedulesAndResultsArgumentYearJSON : SportsOlympicsEventSchedulesAndResultsArgumentJSON
  {
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Year of SportsOlympicsEventSchedulesAndResultsArgumentYearJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Year of SportsOlympicsEventSchedulesAndResultsArgumentYearJSON is not an integer.");
              }
    ...
    public SportsOlympicsEventSchedulesAndResultsArgumentYearJSON()
      {
        flagHasYear = false;
    ...
    public virtual int extraSportsOlympicsEventSchedulesAndResultsArgumentYearComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsOlympicsEventSchedulesAndResultsArgumentYearComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsArgumentYearComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsArgumentYearLookup(string field_name)
      {
    ...
    public void setYear(BigInteger new_value)
      {
        flagHasYear = true;
        if (new_value < 0)
            throw new Exception("The value for field Year of SportsOlympicsEventSchedulesAndResultsArgumentYearJSON is less than the lower bound (0) for that field.");
        storeYear = new_value;
      }
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsArgumentYearAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsArgumentYearSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentYearJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentYearJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentYearJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentYear", ignore_extras);
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentYearJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentYearJSON from_text(string text, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentYearJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentYear", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsOlympicsEventSchedulesAndResultsArgumentYearJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentYearJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentYearJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentYear", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorYear : JSONHoldingIntegerLowerBoundOnlyArrayGenerator
        ...
        protected override void finish()
          {
            if (!(getSportsOlympicsEventSchedulesAndResultsArgumentJSONKey().Equals("Year")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsOlympicsEventSchedulesAndResultsArgumentYearAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsOlympicsEventSchedulesAndResultsArgumentYearJSON result)
          {
        ...
        protected abstract void handle_result(SportsOlympicsEventSchedulesAndResultsArgumentYearJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorYear = new FieldHoldingGeneratorYear("field \"Year\" of the SportsOlympicsEventSchedulesAndResultsArgumentYear class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsOlympicsEventSchedulesAndResultsArgumentYearJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsOlympicsEventSchedulesAndResultsArgumentYearJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsOlympicsEventSchedulesAndResultsArgumentYearJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsOlympicsEventSchedulesAndResultsArgumentYearJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsOlympicsEventSchedulesAndResultsArgumentYearJSON> value;
  };
  };
