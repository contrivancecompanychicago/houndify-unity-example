    ...
    private void  fromJSONRequestedAttribute(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field RequestedAttribute of WeatherConversationStateJSON is not a string.");
    ...
    private void  fromJSONRequestedAlmanacAttribute(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field RequestedAlmanacAttribute of WeatherConversationStateJSON is not a string.");
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Units of WeatherConversationStateJSON is not a string.");
