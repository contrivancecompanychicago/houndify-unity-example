    ...
    private JSONValue  extraBrightnessValueToJSON()
      {
        ...
        if (((double)(long)storeBrightnessValue) == storeBrightnessValue)
    ...
    private JSONValue  extraBrightnessLevelToJSON()
      {
        ...
        if (((double)(long)storeBrightnessLevel) == storeBrightnessLevel)
    ...
    private JSONValue  extraBrightnessDeltaToJSON()
      {
        ...
        if (((double)(long)storeBrightnessDelta) == storeBrightnessDelta)
