                            ...
                            switch (chars[3])
                              {
                                ...
                                case '6':
                                    if ((String.Compare(chars, 4, "Athens", 0, 6, false) == 0) && (chars.Length == 10))
                                        return TypeValueKnownValues.Value_1986Athens;
                                    break;
                                case '8':
                                    switch (chars[4])
                                      {
                            ...
                            switch (chars[3])
                              {
                                ...
                                case '4':
                                    ...
                                    break;
                                case '6':
                                    if ((String.Compare(chars, 4, "TBD", 0, 3, false) == 0) && (chars.Length == 7))
                                        return TypeValueKnownValues.Value_2026TBD;
                                    break;
                                case '8':
    ...
    public static string  stringFromValue(TypeValueKnownValues the_enum)
      {
        switch (the_enum)
          {
            case TypeValueKnownValues.Value_1986Athens:
                return "1986Athens";
            ...
            case TypeValueKnownValues.Value_2024Paris:
                return "2024Paris";
            case TypeValueKnownValues.Value_2026TBD:
                return "2026TBD";
                            ...
                            switch (json_string.getData()[3])
                              {
                                ...
                                case '6':
                                    if ((String.Compare(json_string.getData(), 4, "Athens", 0, 6, false) == 0) && (json_string.getData().Length == 10))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeValueKnownValues.Value_1986Athens;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                case '8':
                            ...
                            switch (json_string.getData()[3])
                              {
                                ...
                                case '4':
                                    ...
                                    break;
                                case '6':
                                    if ((String.Compare(json_string.getData(), 4, "TBD", 0, 3, false) == 0) && (json_string.getData().Length == 7))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeValueKnownValues.Value_2026TBD;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                case '8':
