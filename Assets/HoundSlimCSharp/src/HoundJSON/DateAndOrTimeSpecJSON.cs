        ...
        switch (field_name[0])
          {
            case 'D':
                ...
                break;
            case 'H':
                if ((String.Compare(field_name, 1, "oliday", 0, 6, false) == 0) && (field_name.Length == 7))
            ...
            case 'T':
                switch (field_name[1])
                  {
                    case 'i':
                        if ((String.Compare(field_name, 2, "meMentioned", 0, 11, false) == 0) && (field_name.Length == 13))
        ...
        switch (key[0])
          {
            case 'D':
                ...
                break;
            case 'H':
                if ((String.Compare(key, 1, "oliday", 0, 6, false) == 0) && (key.Length == 7))
                    {
            ...
            case 'T':
                switch (key[1])
                  {
                    case 'i':
                        if ((String.Compare(key, 2, "meMentioned", 0, 11, false) == 0) && (key.Length == 13))
                            {
