/* file "SportsOlympicsEventSchedulesAndResultsArgumentHostJSON.cs" */
...
public class SportsOlympicsEventSchedulesAndResultsArgumentHostJSON : SportsOlympicsEventSchedulesAndResultsArgumentJSON
  {
    ...
    private void  fromJSONHosts(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Hosts of SportsOlympicsEventSchedulesAndResultsArgumentHostJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Hosts of SportsOlympicsEventSchedulesAndResultsArgumentHostJSON has too few elements.");
    ...
    public SportsOlympicsEventSchedulesAndResultsArgumentHostJSON()
      {
        flagHasHosts = false;
    ...
    public virtual int extraSportsOlympicsEventSchedulesAndResultsArgumentHostComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsOlympicsEventSchedulesAndResultsArgumentHostComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsArgumentHostComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsArgumentHostLookup(string field_name)
      {
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsArgumentHostAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsArgumentHostSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentHostJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentHostJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentHost", ignore_extras);
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentHostJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentHostJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentHostJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentHost", ignore_extras);
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentHostJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentHostJSON from_text(string text, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentHostJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentHost", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsOlympicsEventSchedulesAndResultsArgumentHostJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentHostJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentHostJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentHost", ignore_extras);
    ...
    public new abstract class Generator : SportsOlympicsEventSchedulesAndResultsArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsOlympicsEventSchedulesAndResultsArgumentJSONKey().Equals("Host")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsOlympicsEventSchedulesAndResultsArgumentHostAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsOlympicsEventSchedulesAndResultsArgumentHostJSON result)
          {
        ...
        protected abstract void handle_result(SportsOlympicsEventSchedulesAndResultsArgumentHostJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorHosts = new SportsOlympicsGamesCodeJSON.HoldingArrayGenerator("field \"Hosts\" of the SportsOlympicsEventSchedulesAndResultsArgumentHost class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SportsOlympicsEventSchedulesAndResultsArgumentHost class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorHosts = new SportsOlympicsGamesCodeJSON.HoldingArrayGenerator("field \"Hosts\" of the SportsOlympicsEventSchedulesAndResultsArgumentHost class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsOlympicsEventSchedulesAndResultsArgumentHostJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsOlympicsEventSchedulesAndResultsArgumentHostJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsOlympicsEventSchedulesAndResultsArgumentHostJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsOlympicsEventSchedulesAndResultsArgumentHostJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsOlympicsEventSchedulesAndResultsArgumentHostJSON> value;
  };
  };
