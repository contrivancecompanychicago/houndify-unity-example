        ...
        switch (field_name[0])
          {
            ...
            case 'O':
                ...
                break;
            case 'Q':
                if ((String.Compare(field_name, 1, "uerySign", 0, 8, false) == 0) && (field_name.Length == 9))
                    return (flagHasQuerySign ? extraQuerySignToJSON() : null);
                break;
            case 'R':
                if ((String.Compare(field_name, 1, "esultSign", 0, 9, false) == 0) && (field_name.Length == 10))
        ...
        switch (key[0])
          {
            ...
            case 'O':
                ...
                break;
            case 'Q':
                if ((String.Compare(key, 1, "uerySign", 0, 8, false) == 0) && (key.Length == 9))
                    {
                ...
                break;
            case 'R':
                if ((String.Compare(key, 1, "esultSign", 0, 9, false) == 0) && (key.Length == 10))
                    {
