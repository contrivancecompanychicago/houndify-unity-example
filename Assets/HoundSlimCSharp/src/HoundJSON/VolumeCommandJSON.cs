    ...
    private JSONValue  extraVolumeValueToJSON()
      {
        ...
        if (((double)(long)storeVolumeValue) == storeVolumeValue)
    ...
    private JSONValue  extraVolumeLevelToJSON()
      {
        ...
        if (((double)(long)storeVolumeLevel) == storeVolumeLevel)
    ...
    private JSONValue  extraVolumeDeltaToJSON()
      {
        ...
        if (((double)(long)storeVolumeDelta) == storeVolumeDelta)
    ...
    private void  fromJSONCommandType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field CommandType of VolumeCommandJSON is not a string.");
        ...
        switch (json_string.getData()[0])
          {
            case 'A':
                if ((String.Compare(json_string.getData(), 1, "djustVolume", 0, 11, false) == 0) && (json_string.getData().Length == 12))
                      {
                        the_enum = TypeCommandType.CommandType_AdjustVolume;
                        goto enum_is_done;
                      }
                break;
            case 'M':
                if ((String.Compare(json_string.getData(), 1, "uteSound", 0, 8, false) == 0) && (json_string.getData().Length == 9))
                      {
                        the_enum = TypeCommandType.CommandType_MuteSound;
                        goto enum_is_done;
                      }
                break;
            case 'S':
                if ((String.Compare(json_string.getData(), 1, "etVolume", 0, 8, false) == 0) && (json_string.getData().Length == 9))
                      {
                        the_enum = TypeCommandType.CommandType_SetVolume;
                        goto enum_is_done;
                      }
                break;
            case 'U':
                if ((String.Compare(json_string.getData(), 1, "nMuteSound", 0, 10, false) == 0) && (json_string.getData().Length == 11))
                      {
                        the_enum = TypeCommandType.CommandType_UnMuteSound;
                        goto enum_is_done;
                      }
                break;
            default:
        ...
        throw new Exception("The value for field CommandType of VolumeCommandJSON is not one of the legal strings.");
      enum_is_done:;
