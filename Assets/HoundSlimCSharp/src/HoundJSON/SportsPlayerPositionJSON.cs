                ...
                if (String.Compare(chars, 1, "occer", 0, 5, false) == 0)
                  {
                    switch (chars[6])
                      {
                        case 'D':
                            if ((String.Compare(chars, 7, "efender", 0, 7, false) == 0) && (chars.Length == 14))
                                return TypeValueKnownValues.Value_SoccerDefender;
                            break;
                        case 'F':
                            if ((String.Compare(chars, 7, "orward", 0, 6, false) == 0) && (chars.Length == 13))
                ...
                if (String.Compare(json_string.getData(), 1, "occer", 0, 5, false) == 0)
                  {
                    switch (json_string.getData()[6])
                      {
                        case 'D':
                            if ((String.Compare(json_string.getData(), 7, "efender", 0, 7, false) == 0) && (json_string.getData().Length == 14))
                                  {
                                    the_open_enum.in_known_list = true;
                            ...
                            break;
                        case 'F':
                            if ((String.Compare(json_string.getData(), 7, "orward", 0, 6, false) == 0) && (json_string.getData().Length == 13))
                                  {
                                    the_open_enum.in_known_list = true;
