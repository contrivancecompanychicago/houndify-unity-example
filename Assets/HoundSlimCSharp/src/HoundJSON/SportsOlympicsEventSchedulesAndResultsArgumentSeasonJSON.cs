/* file "SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON.cs" */
...
public class SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON : SportsOlympicsEventSchedulesAndResultsArgumentJSON
  {
    ...
    public SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON()
      {
        flagHasSeason = false;
    ...
    public virtual int extraSportsOlympicsEventSchedulesAndResultsArgumentSeasonComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsOlympicsEventSchedulesAndResultsArgumentSeasonComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsArgumentSeasonComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsArgumentSeasonLookup(string field_name)
      {
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsArgumentSeasonAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsArgumentSeasonSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON from_text(string text, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentSeason", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentSeason", ignore_extras);
    ...
    public new abstract class Generator : SportsOlympicsEventSchedulesAndResultsArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsOlympicsEventSchedulesAndResultsArgumentJSONKey().Equals("Season")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsOlympicsEventSchedulesAndResultsArgumentSeasonAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON result)
          {
        ...
        protected abstract void handle_result(SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsOlympicsEventSchedulesAndResultsArgumentSeasonJSON> value;
  };
  };
