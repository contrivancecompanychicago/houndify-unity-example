/* file "SportsStandingsArgumentWildCardJSON.cs" */
...
public class SportsStandingsArgumentWildCardJSON : JSONBase
  {
    ...
    public static TypeArgumentType  stringToArgumentType(string chars)
      {
        if ((String.Compare(chars, 0, "SportsStandingsArgumentWildCard", 0, 31, false) == 0) && (chars.Length == 31))
            return TypeArgumentType.ArgumentType_SportsStandingsArgumentWildCard;
    ...
    public static string  stringFromArgumentType(TypeArgumentType the_enum)
      {
        switch (the_enum)
          {
            case TypeArgumentType.ArgumentType_SportsStandingsArgumentWildCard:
    ...
    private void  fromJSONArgumentType(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field ArgumentType of SportsStandingsArgumentWildCardJSON is not a string.");
        if (!(json_string.getData().Equals("SportsStandingsArgumentWildCard")))
            throw new Exception("The value for field ArgumentType of SportsStandingsArgumentWildCardJSON is not `SportsStandingsArgumentWildCard'.");
        setArgumentType();
      }


    public SportsStandingsArgumentWildCardJSON()
      {
    ...
    public virtual int extraSportsStandingsArgumentWildCardComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsStandingsArgumentWildCardComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsStandingsArgumentWildCardComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsStandingsArgumentWildCardLookup(string field_name)
      {
    ...
    public virtual void extraSportsStandingsArgumentWildCardAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsStandingsArgumentWildCardSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static SportsStandingsArgumentWildCardJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsStandingsArgumentWildCardJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsStandingsArgumentWildCardJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStandingsArgumentWildCard", ignore_extras);
    ...
    public static SportsStandingsArgumentWildCardJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsStandingsArgumentWildCardJSON from_text(string text, bool ignore_extras)
      {
        SportsStandingsArgumentWildCardJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStandingsArgumentWildCard", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsStandingsArgumentWildCardJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static SportsStandingsArgumentWildCardJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsStandingsArgumentWildCardJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsStandingsArgumentWildCard", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorArgumentType : JSONArrayGenerator
  {
    ...
    public List<TypeArgumentType> value;
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsStandingsArgumentWildCardAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsStandingsArgumentWildCardJSON result)
          {
        ...
        protected abstract void handle_result(SportsStandingsArgumentWildCardJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorArgumentType = new FieldHoldingGeneratorArgumentType("field \"ArgumentType\" of the SportsStandingsArgumentWildCard class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsStandingsArgumentWildCardJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SportsStandingsArgumentWildCardJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsStandingsArgumentWildCardJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsStandingsArgumentWildCardJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsStandingsArgumentWildCardJSON> value;
  };
  };
