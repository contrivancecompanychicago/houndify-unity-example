/* file "SportsOlympicsEventSchedulesAndResultsArgumentEventJSON.cs" */
...
public class SportsOlympicsEventSchedulesAndResultsArgumentEventJSON : SportsOlympicsEventSchedulesAndResultsArgumentJSON
  {
    ...
    public SportsOlympicsEventSchedulesAndResultsArgumentEventJSON()
      {
        flagHasEvents = false;
    ...
    public virtual int extraSportsOlympicsEventSchedulesAndResultsArgumentEventComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsOlympicsEventSchedulesAndResultsArgumentEventComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsArgumentEventComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsOlympicsEventSchedulesAndResultsArgumentEventLookup(string field_name)
      {
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsArgumentEventAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsOlympicsEventSchedulesAndResultsArgumentEventSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentEventJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentEventJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentEvent", ignore_extras);
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentEventJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentEventJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentEventJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentEvent", ignore_extras);
    ...
    public static new SportsOlympicsEventSchedulesAndResultsArgumentEventJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentEventJSON from_text(string text, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentEventJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentEvent", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsOlympicsEventSchedulesAndResultsArgumentEventJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsOlympicsEventSchedulesAndResultsArgumentEventJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsOlympicsEventSchedulesAndResultsArgumentEventJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsEventSchedulesAndResultsArgumentEvent", ignore_extras);
    ...
    public new abstract class Generator : SportsOlympicsEventSchedulesAndResultsArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsOlympicsEventSchedulesAndResultsArgumentJSONKey().Equals("Event")))
                throw new Exception("The key field has a value other than `Event'.");
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsOlympicsEventSchedulesAndResultsArgumentEventAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsOlympicsEventSchedulesAndResultsArgumentEventJSON result)
          {
        ...
        protected abstract void handle_result(SportsOlympicsEventSchedulesAndResultsArgumentEventJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorEvents = new SportsOlympicsEventJSON.HoldingArrayGenerator("field \"Events\" of the SportsOlympicsEventSchedulesAndResultsArgumentEvent class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SportsOlympicsEventSchedulesAndResultsArgumentEvent class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorEvents = new SportsOlympicsEventJSON.HoldingArrayGenerator("field \"Events\" of the SportsOlympicsEventSchedulesAndResultsArgumentEvent class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsOlympicsEventSchedulesAndResultsArgumentEventJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsOlympicsEventSchedulesAndResultsArgumentEventJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsOlympicsEventSchedulesAndResultsArgumentEventJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsOlympicsEventSchedulesAndResultsArgumentEventJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsOlympicsEventSchedulesAndResultsArgumentEventJSON> value;
  };
  };
