            ...
            switch (field_name[0])
              {
                ...
                case 'G':
                    ...
                    break;
                case 'U':
                    if ((String.Compare(field_name, 1, "nitOfMeasureAmount", 0, 18, false) == 0) && (field_name.Length == 19))
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorUnitOfMeasureAmount = new UnitOfMeasureAmountJSON.HoldingGenerator("field \"UnitOfMeasureAmount\" of the GeonameAttribute class", ignore_extras);
        ...
        public Generator()
          {
            ...
            fieldGeneratorAttributeValueWrittenForm = new JSONHoldingStringGenerator("field \"AttributeValueWrittenForm\" of the GeonameAttribute class");
            fieldGeneratorAttributeValueRaw = new FieldHoldingGeneratorAttributeValueRaw("field \"AttributeValueRaw\" of the GeonameAttribute class");
            fieldGeneratorUnitOfMeasureAmount = new UnitOfMeasureAmountJSON.HoldingGenerator("field \"UnitOfMeasureAmount\" of the GeonameAttribute class", false);
            fieldGeneratorAttributeValueIsLong = new JSONHoldingBooleanGenerator("field \"AttributeValueIsLong\" of the GeonameAttribute class");
