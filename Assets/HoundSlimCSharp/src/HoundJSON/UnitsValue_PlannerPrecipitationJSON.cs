    ...
    private void  fromJSONFormat(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Format of UnitsValue_PlannerPrecipitationJSON is not a string.");
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Units of UnitsValue_PlannerPrecipitationJSON is not a string.");
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorFormat = new JSONHoldingStringGenerator("field \"Format\" of the UnitsValue_PlannerPrecipitation class");
            fieldGeneratorUnits = new JSONHoldingStringGenerator("field \"Units\" of the UnitsValue_PlannerPrecipitation class");
