...
//@@@            Debug.Assert(!have_value);
    ...
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    switch (key[0])
      {
        case 'A':
            if ((String.Compare(key, 1, "geCalculatorRequestedDateOutOfBounds", 0, 36, false) == 0) && (key.Length == 37))
        ...
        case 'B':
            ...
            break;
        case 'C':
            if ((String.Compare(key, 1, "ontactSaveError", 0, 15, false) == 0) && (key.Length == 16))
        ...
        case 'N':
            ...
            break;
        case 'R':
            if ((String.Compare(key, 1, "equestedDateOutOfBounds", 0, 23, false) == 0) && (key.Length == 24))
                return new RequestedDateOutOfBoundsJSON();
            break;
        case 'S':
            if ((String.Compare(key, 1, "MSDisambiguateError", 0, 19, false) == 0) && (key.Length == 20))
