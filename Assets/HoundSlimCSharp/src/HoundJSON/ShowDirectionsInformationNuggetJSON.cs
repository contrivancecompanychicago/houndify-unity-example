    ...
    private JSONValue  extraDistanceToJSON()
      {
        ...
        if (((double)(long)storeDistance) == storeDistance)
    ...
    private JSONValue  extraTravelTimeToJSON()
      {
        ...
        if (((double)(long)storeTravelTime) == storeTravelTime)
        ...
        switch (key[0])
          {
            ...
            case 'D':
                switch (key[1])
                  {
                    case 'e':
                        if ((String.Compare(key, 2, "stinationMapLocationSpec", 0, 24, false) == 0) && (key.Length == 26))
                            {
            ...
            case 'N':
                ...
                break;
            case 'S':
                if ((String.Compare(key, 1, "tartMapLocationSpec", 0, 19, false) == 0) && (key.Length == 20))
                    {
