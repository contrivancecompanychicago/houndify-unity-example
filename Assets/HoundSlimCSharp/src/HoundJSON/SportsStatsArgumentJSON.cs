...
public class SportsStatsArgumentJSON : JSONBase
  {
    public struct TypeArgumentData
      {
        ...
        public struct Utype
          {
            [FieldOffset(0)]
            public SportsStatsArgumentTypeModifierJSON  choice0;
            [FieldOffset(0)]
    ...
    public virtual int extraSportsStatsArgumentComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsStatsArgumentComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsStatsArgumentComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsStatsArgumentLookup(string field_name)
      {
    ...
    public virtual void extraSportsStatsArgumentAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsStatsArgumentSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static SportsStatsArgumentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    private abstract class FieldGeneratorArgumentData : JSONParallelGenerator
          {
            private SportsStatsArgumentTypeModifierJSON.HoldingGenerator field0;
    ...
    private class FieldHoldingArrayGeneratorArgumentData : JSONArrayGenerator
  {
    ...
    private class FieldHoldingArrayGeneratorArgumentID : JSONHoldingIntegerLowerBoundOnlyArrayGenerator
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorArgumentData = new FieldHoldingGeneratorArgumentData("field \"ArgumentData\" of the SportsStatsArgument class", ignore_extras);
        ...
        public Generator()
          {
            fieldGeneratorArgumentData = new FieldHoldingGeneratorArgumentData("field \"ArgumentData\" of the SportsStatsArgument class", false);
            fieldGeneratorArgumentID = new FieldHoldingGeneratorArgumentID("field \"ArgumentID\" of the SportsStatsArgument class");
