...
public class CalendarCreateDataJSON : JSONBase
  {
    public enum TypeNextCreateAction
      {
    ...
    public static TypeNextCreateAction  stringToNextCreateAction(string chars)
      {
        switch (chars[0])
          {
            case 'A':
                if (String.Compare(chars, 1, "sk", 0, 2, false) == 0)
                  {
                    switch (chars[3])
                      {
                        case 'D':
                            if (String.Compare(chars, 4, "ate", 0, 3, false) == 0)
                              {
                                if (chars.Length == 7)
                                  {
                                    return TypeNextCreateAction.NextCreateAction_AskDate;
                                  }
                                switch (chars[7])
                                  {
                                    case 'A':
                                        if ((String.Compare(chars, 8, "ndTime", 0, 6, false) == 0) && (chars.Length == 14))
                                            return TypeNextCreateAction.NextCreateAction_AskDateAndTime;
                                        break;
                                    default:
                                        break;
                                  }
                            ...
                            break;
                        case 'T':
                            if ((String.Compare(chars, 4, "ime", 0, 3, false) == 0) && (chars.Length == 7))
                                return TypeNextCreateAction.NextCreateAction_AskTime;
                            break;
                        default:
                            break;
                      }
            ...
            case 'C':
                if ((String.Compare(chars, 1, "reateItem", 0, 9, false) == 0) && (chars.Length == 10))
                    return TypeNextCreateAction.NextCreateAction_CreateItem;
                break;
            case 'U':
                if ((String.Compare(chars, 1, "ndefined", 0, 8, false) == 0) && (chars.Length == 9))
                    return TypeNextCreateAction.NextCreateAction_Undefined;
                break;
            default:
                break;
          }
        throw new Exception("The value for field `NextCreateAction' is not one of the legal values.");
      }

    public static string  stringFromNextCreateAction(TypeNextCreateAction the_enum)
      {
        switch (the_enum)
          {
            case TypeNextCreateAction.NextCreateAction_Undefined:
                return "Undefined";
            case TypeNextCreateAction.NextCreateAction_CreateItem:
                return "CreateItem";
            case TypeNextCreateAction.NextCreateAction_AskDateAndTime:
                return "AskDateAndTime";
            case TypeNextCreateAction.NextCreateAction_AskDate:
                return "AskDate";
            case TypeNextCreateAction.NextCreateAction_AskTime:
                return "AskTime";
            default:
                Debug.Assert(false);
                return null;
    ...
    public enum TypeLastCreateAction
      {
    ...
    public static TypeLastCreateAction  stringToLastCreateAction(string chars)
      {
        switch (chars[0])
          {
            case 'A':
                    ...
                    switch (chars[3])
                      {
                            ...
                            if (String.Compare(chars, 4, "ate", 0, 3, false) == 0)
                              {
                                if (chars.Length == 7)
                                  {
                                    return TypeLastCreateAction.LastCreateAction_AskDate;
                                  }
                                switch (chars[7])
                                  {
                                    case 'A':
                                        if ((String.Compare(chars, 8, "ndTime", 0, 6, false) == 0) && (chars.Length == 14))
                                            return TypeLastCreateAction.LastCreateAction_AskDateAndTime;
                                        break;
                                    default:
                                        break;
                                  }
                        ...
                        case 'T':
                            if ((String.Compare(chars, 4, "ime", 0, 3, false) == 0) && (chars.Length == 7))
                                return TypeLastCreateAction.LastCreateAction_AskTime;
                            break;
                        default:
                            break;
                      }
            ...
            case 'C':
                if ((String.Compare(chars, 1, "reateItem", 0, 9, false) == 0) && (chars.Length == 10))
                    return TypeLastCreateAction.LastCreateAction_CreateItem;
                break;
            case 'U':
                if ((String.Compare(chars, 1, "ndefined", 0, 8, false) == 0) && (chars.Length == 9))
                    return TypeLastCreateAction.LastCreateAction_Undefined;
                break;
            default:
                break;
          }
        throw new Exception("The value for field `LastCreateAction' is not one of the legal values.");
      }

    public static string  stringFromLastCreateAction(TypeLastCreateAction the_enum)
      {
        switch (the_enum)
          {
            case TypeLastCreateAction.LastCreateAction_Undefined:
                return "Undefined";
            case TypeLastCreateAction.LastCreateAction_CreateItem:
                return "CreateItem";
            case TypeLastCreateAction.LastCreateAction_AskDateAndTime:
                return "AskDateAndTime";
            case TypeLastCreateAction.LastCreateAction_AskDate:
                return "AskDate";
            case TypeLastCreateAction.LastCreateAction_AskTime:
                return "AskTime";
            default:
                Debug.Assert(false);
                return null;
    ...
    private bool flagHasDurationSeconds;
    private BigInteger storeDurationSeconds;
    ...
    private void  fromJSONNextCreateAction(JSONValue json_value, bool ignore_extras)
      {
        ...
        switch (json_string.getData()[0])
          {
                ...
                if (String.Compare(json_string.getData(), 1, "sk", 0, 2, false) == 0)
                  {
                    switch (json_string.getData()[3])
                      {
                        case 'D':
                            if (String.Compare(json_string.getData(), 4, "ate", 0, 3, false) == 0)
                              {
                                if (json_string.getData().Length == 7)
                                  {
                                      {
                                        the_enum = TypeNextCreateAction.NextCreateAction_AskDate;
                                        goto enum_is_done;
                                      }
                                  }
                                switch (json_string.getData()[7])
                                  {
                                    case 'A':
                                        if ((String.Compare(json_string.getData(), 8, "ndTime", 0, 6, false) == 0) && (json_string.getData().Length == 14))
                                              {
                                                the_enum = TypeNextCreateAction.NextCreateAction_AskDateAndTime;
                                                goto enum_is_done;
                                              }
                                        break;
                                    default:
                            ...
                            break;
                        case 'T':
                            if ((String.Compare(json_string.getData(), 4, "ime", 0, 3, false) == 0) && (json_string.getData().Length == 7))
                                  {
                                    the_enum = TypeNextCreateAction.NextCreateAction_AskTime;
                                    goto enum_is_done;
                                  }
                            break;
                        default:
            ...
            case 'C':
                if ((String.Compare(json_string.getData(), 1, "reateItem", 0, 9, false) == 0) && (json_string.getData().Length == 10))
                      {
                        the_enum = TypeNextCreateAction.NextCreateAction_CreateItem;
                        goto enum_is_done;
                      }
                break;
            case 'U':
                if ((String.Compare(json_string.getData(), 1, "ndefined", 0, 8, false) == 0) && (json_string.getData().Length == 9))
                      {
                        the_enum = TypeNextCreateAction.NextCreateAction_Undefined;
                        goto enum_is_done;
                      }
                break;
            default:
        ...
        throw new Exception("The value for field NextCreateAction of CalendarCreateDataJSON is not one of the legal strings.");
      enum_is_done:;
    ...
    private void  fromJSONLastCreateAction(JSONValue json_value, bool ignore_extras)
      {
        ...
        switch (json_string.getData()[0])
          {
                    ...
                    switch (json_string.getData()[3])
                      {
                            ...
                            if (String.Compare(json_string.getData(), 4, "ate", 0, 3, false) == 0)
                              {
                                if (json_string.getData().Length == 7)
                                  {
                                      {
                                        the_enum = TypeLastCreateAction.LastCreateAction_AskDate;
                                        goto enum_is_done;
                                      }
                                  }
                                switch (json_string.getData()[7])
                                  {
                                    case 'A':
                                        if ((String.Compare(json_string.getData(), 8, "ndTime", 0, 6, false) == 0) && (json_string.getData().Length == 14))
                                              {
                                                the_enum = TypeLastCreateAction.LastCreateAction_AskDateAndTime;
                                                goto enum_is_done;
                                              }
                                        break;
                                    default:
                        ...
                        case 'T':
                            if ((String.Compare(json_string.getData(), 4, "ime", 0, 3, false) == 0) && (json_string.getData().Length == 7))
                                  {
                                    the_enum = TypeLastCreateAction.LastCreateAction_AskTime;
                                    goto enum_is_done;
                                  }
                            break;
                        default:
            ...
            case 'C':
                if ((String.Compare(json_string.getData(), 1, "reateItem", 0, 9, false) == 0) && (json_string.getData().Length == 10))
                      {
                        the_enum = TypeLastCreateAction.LastCreateAction_CreateItem;
                        goto enum_is_done;
                      }
                break;
            case 'U':
                if ((String.Compare(json_string.getData(), 1, "ndefined", 0, 8, false) == 0) && (json_string.getData().Length == 9))
                      {
                        the_enum = TypeLastCreateAction.LastCreateAction_Undefined;
                        goto enum_is_done;
                      }
                break;
            default:
        ...
        throw new Exception("The value for field LastCreateAction of CalendarCreateDataJSON is not one of the legal strings.");
      enum_is_done:;
    ...
    private void  fromJSONDurationSeconds(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        BigInteger extracted_integer;
        JSONIntegerValue json_integer = json_value.integer_value();
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field DurationSeconds of CalendarCreateDataJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field DurationSeconds of CalendarCreateDataJSON is not an integer.");
              }
            extracted_integer = json_rational.getInteger()        ;
          }
        else
    ...
    private void  fromJSONAttendees(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (count1 < 1)
            throw new Exception("The value for field Attendees of CalendarCreateDataJSON has too few elements.");
    ...
    private void  fromJSONReminders(JSONValue json_value, bool ignore_extras)
      {
        ...
        int count1 = json_array1.componentCount();
        if (count1 < 1)
            throw new Exception("The value for field Reminders of CalendarCreateDataJSON has too few elements.");
    ...
    public BigInteger  getDurationSeconds()
      {
        Debug.Assert(flagHasDurationSeconds);
    ...
    public void setDurationSeconds(BigInteger new_value)
      {
        ...
        if (flagHasDurationSeconds)
          {
            ...
            handler.number_value(storeDurationSeconds);
          }
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorFrequencyType : JSONArrayGenerator
  {
    ...
    private class FieldHoldingGeneratorDurationSeconds : JSONHoldingIntegerUnboundRangeGenerator
          {
            public FieldHoldingGeneratorDurationSeconds(String what) : base(what)
              {
              }
          };
    private class FieldHoldingArrayGeneratorDurationSeconds : JSONHoldingIntegerUnboundRangeArrayGenerator
          {
            public FieldHoldingArrayGeneratorDurationSeconds(String what) : base(what)
              {
              }
          };
        private FieldHoldingGeneratorDurationSeconds fieldGeneratorDurationSeconds;
            ...
            switch (field_name[0])
              {
                case 'A':
                    ...
                    break;
                case 'C':
                    if (String.Compare(field_name, 1, "alendar", 0, 7, false) == 0)
                      {
                        switch (field_name[8])
                          {
                            case 'I':
                    ...
                    switch (field_name[1])
                      {
                        case 'e':
                            ...
                            break;
                        case 'u':
                            if ((String.Compare(field_name, 2, "rationSeconds", 0, 13, false) == 0) && (field_name.Length == 15))
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorDurationSeconds = new FieldHoldingGeneratorDurationSeconds("field \"DurationSeconds\" of the CalendarCreateData class");
