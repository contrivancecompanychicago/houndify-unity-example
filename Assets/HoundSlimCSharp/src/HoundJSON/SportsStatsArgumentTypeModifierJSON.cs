    ...
    public static TypeModifierNameKnownValues  stringToModifierName(string chars)
      {
        switch (chars[0])
          {
            case 'N':
                if (String.Compare(chars, 1, "HL", 0, 2, false) == 0)
                  {
                    switch (chars[3])
                      {
                        case 'E':
                            switch (chars[4])
                              {
                                case 'm':
                                    if ((String.Compare(chars, 5, "ptyNet", 0, 6, false) == 0) && (chars.Length == 11))
                                        return TypeModifierNameKnownValues.ModifierName_NHLEmptyNet;
                                    break;
                                case 'v':
                                    if ((String.Compare(chars, 5, "enStrength", 0, 10, false) == 0) && (chars.Length == 15))
                                        return TypeModifierNameKnownValues.ModifierName_NHLEvenStrength;
                                    break;
                                default:
                                    break;
                              }
                        ...
                        case 'P':
                            switch (chars[4])
                              {
                                case 'e':
                                    if ((String.Compare(chars, 5, "nalty", 0, 5, false) == 0) && (chars.Length == 10))
                                        return TypeModifierNameKnownValues.ModifierName_NHLPenalty;
                                    break;
                                case 'o':
                                    if ((String.Compare(chars, 5, "werPlay", 0, 7, false) == 0) && (chars.Length == 12))
                                        return TypeModifierNameKnownValues.ModifierName_NHLPowerPlay;
                                    break;
                                default:
                                    break;
                              }
                            break;
                        case 'S':
                            if (String.Compare(chars, 4, "ho", 0, 2, false) == 0)
                              {
                                switch (chars[6])
                                  {
                                    case 'o':
                                        if ((String.Compare(chars, 7, "tout", 0, 4, false) == 0) && (chars.Length == 11))
                                            return TypeModifierNameKnownValues.ModifierName_NHLShootout;
                                        break;
                                    case 'r':
                                        if ((String.Compare(chars, 7, "tHanded", 0, 7, false) == 0) && (chars.Length == 14))
                                            return TypeModifierNameKnownValues.ModifierName_NHLShortHanded;
                                        break;
                                    default:
                                        break;
                                  }
            ...
            case 'U':
                if ((String.Compare(chars, 1, "nknown", 0, 6, false) == 0) && (chars.Length == 7))
                    return TypeModifierNameKnownValues.ModifierName_Unknown;
                break;
            default:
                break;
          }
    ...
    private void  fromJSONModifierName(JSONValue json_value, bool ignore_extras)
      {
        ...
        switch (json_string.getData()[0])
          {
            case 'N':
                if (String.Compare(json_string.getData(), 1, "HL", 0, 2, false) == 0)
                  {
                    switch (json_string.getData()[3])
                      {
                        case 'E':
                            switch (json_string.getData()[4])
                              {
                                case 'm':
                                    if ((String.Compare(json_string.getData(), 5, "ptyNet", 0, 6, false) == 0) && (json_string.getData().Length == 11))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeModifierNameKnownValues.ModifierName_NHLEmptyNet;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                case 'v':
                                    if ((String.Compare(json_string.getData(), 5, "enStrength", 0, 10, false) == 0) && (json_string.getData().Length == 15))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeModifierNameKnownValues.ModifierName_NHLEvenStrength;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                default:
                        ...
                        case 'P':
                            switch (json_string.getData()[4])
                              {
                                case 'e':
                                    if ((String.Compare(json_string.getData(), 5, "nalty", 0, 5, false) == 0) && (json_string.getData().Length == 10))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeModifierNameKnownValues.ModifierName_NHLPenalty;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                case 'o':
                                    if ((String.Compare(json_string.getData(), 5, "werPlay", 0, 7, false) == 0) && (json_string.getData().Length == 12))
                                          {
                                            the_open_enum.in_known_list = true;
                                            the_open_enum.list_value = TypeModifierNameKnownValues.ModifierName_NHLPowerPlay;
                                            goto open_enum_is_done;
                                          }
                                    break;
                                default:
                            ...
                            break;
                        case 'S':
                            if (String.Compare(json_string.getData(), 4, "ho", 0, 2, false) == 0)
                              {
                                switch (json_string.getData()[6])
                                  {
                                    case 'o':
                                        if ((String.Compare(json_string.getData(), 7, "tout", 0, 4, false) == 0) && (json_string.getData().Length == 11))
                                              {
                                                the_open_enum.in_known_list = true;
                                                the_open_enum.list_value = TypeModifierNameKnownValues.ModifierName_NHLShootout;
                                                goto open_enum_is_done;
                                              }
                                        break;
                                    case 'r':
                                        if ((String.Compare(json_string.getData(), 7, "tHanded", 0, 7, false) == 0) && (json_string.getData().Length == 14))
                                              {
                                                the_open_enum.in_known_list = true;
                                                the_open_enum.list_value = TypeModifierNameKnownValues.ModifierName_NHLShortHanded;
                                                goto open_enum_is_done;
                                              }
                                        break;
                                    default:
            ...
            case 'U':
                if ((String.Compare(json_string.getData(), 1, "nknown", 0, 6, false) == 0) && (json_string.getData().Length == 7))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeModifierNameKnownValues.ModifierName_Unknown;
                        goto open_enum_is_done;
                      }
                break;
            default:
