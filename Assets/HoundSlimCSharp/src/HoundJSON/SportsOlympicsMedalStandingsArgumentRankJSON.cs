/* file "SportsOlympicsMedalStandingsArgumentRankJSON.cs" */
...
public class SportsOlympicsMedalStandingsArgumentRankJSON : SportsOlympicsMedalStandingsArgumentJSON
  {
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field Rank of SportsOlympicsMedalStandingsArgumentRankJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field Rank of SportsOlympicsMedalStandingsArgumentRankJSON is not an integer.");
              }
    ...
    public SportsOlympicsMedalStandingsArgumentRankJSON()
      {
        flagHasRank = false;
    ...
    public virtual int extraSportsOlympicsMedalStandingsArgumentRankComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsOlympicsMedalStandingsArgumentRankComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsOlympicsMedalStandingsArgumentRankComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsOlympicsMedalStandingsArgumentRankLookup(string field_name)
      {
    ...
    public void setRank(BigInteger new_value)
      {
        flagHasRank = true;
        if (new_value < 1)
            throw new Exception("The value for field Rank of SportsOlympicsMedalStandingsArgumentRankJSON is less than the lower bound (1) for that field.");
        storeRank = new_value;
      }
    ...
    public virtual void extraSportsOlympicsMedalStandingsArgumentRankAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsOlympicsMedalStandingsArgumentRankSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new SportsOlympicsMedalStandingsArgumentRankJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsMedalStandingsArgumentRankJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentRank", ignore_extras);
    ...
    public static new SportsOlympicsMedalStandingsArgumentRankJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsMedalStandingsArgumentRankJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsMedalStandingsArgumentRankJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentRank", ignore_extras);
    ...
    public static new SportsOlympicsMedalStandingsArgumentRankJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsMedalStandingsArgumentRankJSON from_text(string text, bool ignore_extras)
      {
        SportsOlympicsMedalStandingsArgumentRankJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentRank", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsOlympicsMedalStandingsArgumentRankJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsOlympicsMedalStandingsArgumentRankJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsOlympicsMedalStandingsArgumentRankJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentRank", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorRank : JSONHoldingIntegerLowerBoundOnlyArrayGenerator
        ...
        protected override void finish()
          {
            if (!(getSportsOlympicsMedalStandingsArgumentJSONKey().Equals("Rank")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsOlympicsMedalStandingsArgumentRankAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsOlympicsMedalStandingsArgumentRankJSON result)
          {
        ...
        protected abstract void handle_result(SportsOlympicsMedalStandingsArgumentRankJSON new_result);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsOlympicsMedalStandingsArgumentRankJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsOlympicsMedalStandingsArgumentRankJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsOlympicsMedalStandingsArgumentRankJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsOlympicsMedalStandingsArgumentRankJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsOlympicsMedalStandingsArgumentRankJSON> value;
  };
  };
