/* file "SportsOlympicsMedalStandingsArgumentSeasonJSON.cs" */
...
public class SportsOlympicsMedalStandingsArgumentSeasonJSON : SportsOlympicsMedalStandingsArgumentJSON
  {
    ...
    public SportsOlympicsMedalStandingsArgumentSeasonJSON()
      {
        flagHasSeason = false;
    ...
    public virtual int extraSportsOlympicsMedalStandingsArgumentSeasonComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsOlympicsMedalStandingsArgumentSeasonComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsOlympicsMedalStandingsArgumentSeasonComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsOlympicsMedalStandingsArgumentSeasonLookup(string field_name)
      {
    ...
    public virtual void extraSportsOlympicsMedalStandingsArgumentSeasonAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsOlympicsMedalStandingsArgumentSeasonSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static new SportsOlympicsMedalStandingsArgumentSeasonJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsMedalStandingsArgumentSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentSeason", ignore_extras);
    ...
    public static new SportsOlympicsMedalStandingsArgumentSeasonJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsMedalStandingsArgumentSeasonJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsMedalStandingsArgumentSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentSeason", ignore_extras);
    ...
    public static new SportsOlympicsMedalStandingsArgumentSeasonJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsOlympicsMedalStandingsArgumentSeasonJSON from_text(string text, bool ignore_extras)
      {
        SportsOlympicsMedalStandingsArgumentSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentSeason", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsOlympicsMedalStandingsArgumentSeasonJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsOlympicsMedalStandingsArgumentSeasonJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsOlympicsMedalStandingsArgumentSeasonJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsArgumentSeason", ignore_extras);
    ...
    public new abstract class Generator : SportsOlympicsMedalStandingsArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsOlympicsMedalStandingsArgumentJSONKey().Equals("Season")))
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsOlympicsMedalStandingsArgumentSeasonAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsOlympicsMedalStandingsArgumentSeasonJSON result)
          {
        ...
        protected abstract void handle_result(SportsOlympicsMedalStandingsArgumentSeasonJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorSeason = new SportsOlympicsSeasonJSON.HoldingGenerator("field \"Season\" of the SportsOlympicsMedalStandingsArgumentSeason class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SportsOlympicsMedalStandingsArgumentSeason class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorSeason = new SportsOlympicsSeasonJSON.HoldingGenerator("field \"Season\" of the SportsOlympicsMedalStandingsArgumentSeason class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsOlympicsMedalStandingsArgumentSeasonJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsOlympicsMedalStandingsArgumentSeasonJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsOlympicsMedalStandingsArgumentSeasonJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsOlympicsMedalStandingsArgumentSeasonJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsOlympicsMedalStandingsArgumentSeasonJSON> value;
  };
  };
