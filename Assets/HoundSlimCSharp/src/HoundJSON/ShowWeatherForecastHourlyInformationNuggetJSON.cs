    ...
    private void  fromJSONRequestedAttribute(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field RequestedAttribute of ShowWeatherForecastHourlyInformationNuggetJSON is not a string.");
    ...
    private void  fromJSONRequestedAttributeAction(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field RequestedAttributeAction of ShowWeatherForecastHourlyInformationNuggetJSON is not a string.");
                ...
                switch (key[1])
                  {
                    case 'e':
                        ...
                        break;
                    case 't':
                        if ((String.Compare(key, 2, "artDateAndTime", 0, 14, false) == 0) && (key.Length == 16))
                            {
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorRequestedAttribute = new JSONHoldingStringGenerator("field \"RequestedAttribute\" of the ShowWeatherForecastHourlyInformationNugget class");
            fieldGeneratorRequestedAttributeAction = new FieldHoldingGeneratorRequestedAttributeAction("field \"RequestedAttributeAction\" of the ShowWeatherForecastHourlyInformationNugget class");
