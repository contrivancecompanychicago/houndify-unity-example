/* file "ReadOutputOverrideCommandJSON.cs" */
...
public class ReadOutputOverrideCommandJSON : CommandResultJSON
  {
    ...
    private void  fromJSONFunctionText(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field FunctionText of ReadOutputOverrideCommandJSON is not a string.");
    ...
    private void  fromJSONFunctionLanguage(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field FunctionLanguage of ReadOutputOverrideCommandJSON is not a string.");
    ...
    public ReadOutputOverrideCommandJSON()
      {
    ...
    public virtual int extraReadOutputOverrideCommandComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraReadOutputOverrideCommandComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraReadOutputOverrideCommandComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraReadOutputOverrideCommandLookup(string field_name)
      {
    ...
    public override int extraCommandResultComponentCount()
      {
        ...
        if (flagHasFunctionSource)
            ++result;
        result += extraReadOutputOverrideCommandComponentCount();
        return result;
      }
    public override string extraCommandResultComponentKey(int component_num)
      {
        ...
        return extraReadOutputOverrideCommandComponentKey(remainder);
      }
    public override JSONValue extraCommandResultComponentValue(int component_num)
      {
        ...
        return extraReadOutputOverrideCommandComponentValue(remainder);
      }
    public override JSONValue extraCommandResultLookup(string field_name)
      {
        ...
        return extraReadOutputOverrideCommandLookup(field_name);
      }
    ...
    public virtual void extraReadOutputOverrideCommandAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraReadOutputOverrideCommandSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraReadOutputOverrideCommandLookup(key);
        if (old_field == null)
          {
            extraReadOutputOverrideCommandAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraCommandResultSetField(string key, JSONValue new_component)
      {
        ...
        extraReadOutputOverrideCommandSetField(key, new_component);
      }
    ...
    public static new ReadOutputOverrideCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ReadOutputOverrideCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ReadOutputOverrideCommand", ignore_extras);
    ...
    public static new ReadOutputOverrideCommandJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ReadOutputOverrideCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        ReadOutputOverrideCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ReadOutputOverrideCommand", ignore_extras);
    ...
    public static new ReadOutputOverrideCommandJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new ReadOutputOverrideCommandJSON from_text(string text, bool ignore_extras)
      {
        ReadOutputOverrideCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ReadOutputOverrideCommand", ignore_extras);
            JSONParse.parse_json_value(text, "Text for ReadOutputOverrideCommandJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new ReadOutputOverrideCommandJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        ReadOutputOverrideCommandJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type ReadOutputOverrideCommand", ignore_extras);
    ...
    public new abstract class Generator : CommandResultJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getCommandResultJSONKey().Equals("ReadOutputOverride")))
                throw new Exception("The key field has a value other than `ReadOutputOverride'.");
            ReadOutputOverrideCommandJSON result = new ReadOutputOverrideCommandJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraReadOutputOverrideCommandAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(CommandResultJSON new_result)
          {
            handle_result((ReadOutputOverrideCommandJSON )new_result);
          }
        protected void finish(ReadOutputOverrideCommandJSON result)
          {
        ...
        protected abstract void handle_result(ReadOutputOverrideCommandJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorFunctionText = new JSONHoldingStringGenerator("field \"FunctionText\" of the ReadOutputOverrideCommand class");
            fieldGeneratorFunctionLanguage = new JSONHoldingStringGenerator("field \"FunctionLanguage\" of the ReadOutputOverrideCommand class");
            fieldGeneratorFunctionSource = new UploadedCodeSourceJSON.HoldingGenerator("field \"FunctionSource\" of the ReadOutputOverrideCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the ReadOutputOverrideCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorFunctionText = new JSONHoldingStringGenerator("field \"FunctionText\" of the ReadOutputOverrideCommand class");
            fieldGeneratorFunctionLanguage = new JSONHoldingStringGenerator("field \"FunctionLanguage\" of the ReadOutputOverrideCommand class");
            fieldGeneratorFunctionSource = new UploadedCodeSourceJSON.HoldingGenerator("field \"FunctionSource\" of the ReadOutputOverrideCommand class", false);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(ReadOutputOverrideCommandJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public ReadOutputOverrideCommandJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<ReadOutputOverrideCommandJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<ReadOutputOverrideCommandJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<ReadOutputOverrideCommandJSON> value;
  };
  };
