    ...
    private void  fromJSONRequestedAttribute(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field RequestedAttribute of ShowWeatherPlannerInformationNuggetJSON is not a string.");
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorRequestedAttribute = new JSONHoldingStringGenerator("field \"RequestedAttribute\" of the ShowWeatherPlannerInformationNugget class");
