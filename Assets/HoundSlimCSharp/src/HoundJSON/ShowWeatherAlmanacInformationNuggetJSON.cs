...
public class ShowWeatherAlmanacInformationNuggetJSON : WeatherInformationNuggetJSON
  {
    ...
    private string storeRequestedAlmanacAttribute;
    ...
    private JSONValue  extraRequestedAlmanacAttributeToJSON()
      {
        JSONStringValue generated_string_RequestedAlmanacAttribute = new JSONStringValue(storeRequestedAlmanacAttribute);
    ...
    private void  fromJSONRequestedAlmanacAttribute(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field RequestedAlmanacAttribute of ShowWeatherAlmanacInformationNuggetJSON is not a string.");
        setRequestedAlmanacAttribute(json_string.getData());
      }
    ...
    public string  getRequestedAlmanacAttribute()
      {
    ...
    public void setRequestedAlmanacAttribute(string new_value)
      {
    ...
    public new abstract class Generator : WeatherInformationNuggetJSON.Generator
      {
        ...
        private JSONHoldingStringGenerator fieldGeneratorRequestedAlmanacAttribute;
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorRequestedAlmanacAttribute = new JSONHoldingStringGenerator("field \"RequestedAlmanacAttribute\" of the ShowWeatherAlmanacInformationNugget class");
