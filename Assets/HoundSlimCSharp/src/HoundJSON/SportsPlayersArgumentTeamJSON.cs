/* file "SportsPlayersArgumentTeamJSON.cs" */
...
public class SportsPlayersArgumentTeamJSON : SportsPlayersArgumentJSON
  {
    ...
    private void  fromJSONTeamID(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field TeamID of SportsPlayersArgumentTeamJSON is not a string.");
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field ResultReference of SportsPlayersArgumentTeamJSON is not true for false.");
              }
          }
    ...
    public SportsPlayersArgumentTeamJSON()
      {
        flagHasTeamID = false;
    ...
    public virtual int extraSportsPlayersArgumentTeamComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsPlayersArgumentTeamComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsPlayersArgumentTeamComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsPlayersArgumentTeamLookup(string field_name)
      {
    ...
    public override int extraSportsPlayersArgumentComponentCount()
      {
        ...
        if (flagHasResultReference)
            ++result;
        result += extraSportsPlayersArgumentTeamComponentCount();
        return result;
      }
    public override string extraSportsPlayersArgumentComponentKey(int component_num)
      {
        ...
        return extraSportsPlayersArgumentTeamComponentKey(remainder);
      }
    public override JSONValue extraSportsPlayersArgumentComponentValue(int component_num)
      {
        ...
        return extraSportsPlayersArgumentTeamComponentValue(remainder);
      }
    public override JSONValue extraSportsPlayersArgumentLookup(string field_name)
      {
        ...
        return extraSportsPlayersArgumentTeamLookup(field_name);
      }
    ...
    public virtual void extraSportsPlayersArgumentTeamAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsPlayersArgumentTeamSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraSportsPlayersArgumentTeamLookup(key);
        if (old_field == null)
          {
            extraSportsPlayersArgumentTeamAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraSportsPlayersArgumentSetField(string key, JSONValue new_component)
      {
        ...
        extraSportsPlayersArgumentTeamSetField(key, new_component);
      }
    ...
    public static new SportsPlayersArgumentTeamJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsPlayersArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayersArgumentTeam", ignore_extras);
    ...
    public static new SportsPlayersArgumentTeamJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsPlayersArgumentTeamJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsPlayersArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayersArgumentTeam", ignore_extras);
    ...
    public static new SportsPlayersArgumentTeamJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsPlayersArgumentTeamJSON from_text(string text, bool ignore_extras)
      {
        SportsPlayersArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayersArgumentTeam", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsPlayersArgumentTeamJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsPlayersArgumentTeamJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsPlayersArgumentTeamJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayersArgumentTeam", ignore_extras);
    ...
    public new abstract class Generator : SportsPlayersArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsPlayersArgumentJSONKey().Equals("Team")))
                throw new Exception("The key field has a value other than `Team'.");
            SportsPlayersArgumentTeamJSON result = new SportsPlayersArgumentTeamJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsPlayersArgumentTeamAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(SportsPlayersArgumentJSON new_result)
          {
            handle_result((SportsPlayersArgumentTeamJSON )new_result);
          }
        protected void finish(SportsPlayersArgumentTeamJSON result)
          {
        ...
        protected abstract void handle_result(SportsPlayersArgumentTeamJSON new_result);
        ...
        public Generator() : base(false)
          {
            fieldGeneratorTeamID = new JSONHoldingStringGenerator("field \"TeamID\" of the SportsPlayersArgumentTeam class");
            fieldGeneratorTeamLeague = new SportsLeagueCodeJSON.HoldingGenerator("field \"TeamLeague\" of the SportsPlayersArgumentTeam class", false);
            fieldGeneratorResultReference = new JSONHoldingBooleanGenerator("field \"ResultReference\" of the SportsPlayersArgumentTeam class");
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsPlayersArgumentTeamJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsPlayersArgumentTeamJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsPlayersArgumentTeamJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsPlayersArgumentTeamJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsPlayersArgumentTeamJSON> value;
  };
  };
