/* file "SportsPlayersArgumentPlayerJSON.cs" */
...
public class SportsPlayersArgumentPlayerJSON : SportsPlayersArgumentJSON
  {
    ...
    private void  fromJSONPlayerID(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field PlayerID of SportsPlayersArgumentPlayerJSON is not a string.");
    ...
    public SportsPlayersArgumentPlayerJSON()
      {
    ...
    public virtual int extraSportsPlayersArgumentPlayerComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsPlayersArgumentPlayerComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsPlayersArgumentPlayerComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsPlayersArgumentPlayerLookup(string field_name)
      {
    ...
    public override int extraSportsPlayersArgumentComponentCount()
      {
        ...
        if (flagHasResultReference)
            ++result;
        result += extraSportsPlayersArgumentPlayerComponentCount();
        return result;
      }
    public override string extraSportsPlayersArgumentComponentKey(int component_num)
      {
        ...
        return extraSportsPlayersArgumentPlayerComponentKey(remainder);
      }
    public override JSONValue extraSportsPlayersArgumentComponentValue(int component_num)
      {
        ...
        return extraSportsPlayersArgumentPlayerComponentValue(remainder);
      }
    public override JSONValue extraSportsPlayersArgumentLookup(string field_name)
      {
        ...
        return extraSportsPlayersArgumentPlayerLookup(field_name);
      }
    ...
    public virtual void extraSportsPlayersArgumentPlayerAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsPlayersArgumentPlayerSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);

        JSONValue old_field = extraSportsPlayersArgumentPlayerLookup(key);
        if (old_field == null)
          {
            extraSportsPlayersArgumentPlayerAppendPair(key, new_component);
          }
        else
          {
    ...
    public override void extraSportsPlayersArgumentSetField(string key, JSONValue new_component)
      {
        ...
        extraSportsPlayersArgumentPlayerSetField(key, new_component);
      }
    ...
    public static new SportsPlayersArgumentPlayerJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsPlayersArgumentPlayerJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayersArgumentPlayer", ignore_extras);
    ...
    public static new SportsPlayersArgumentPlayerJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsPlayersArgumentPlayerJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsPlayersArgumentPlayerJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayersArgumentPlayer", ignore_extras);
    ...
    public static new SportsPlayersArgumentPlayerJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static new SportsPlayersArgumentPlayerJSON from_text(string text, bool ignore_extras)
      {
        SportsPlayersArgumentPlayerJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayersArgumentPlayer", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsPlayersArgumentPlayerJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static new SportsPlayersArgumentPlayerJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsPlayersArgumentPlayerJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsPlayersArgumentPlayer", ignore_extras);
    ...
    public new abstract class Generator : SportsPlayersArgumentJSON.Generator
      {
        ...
        protected override void finish()
          {
            if (!(getSportsPlayersArgumentJSONKey().Equals("Player")))
                throw new Exception("The key field has a value other than `Player'.");
            SportsPlayersArgumentPlayerJSON result = new SportsPlayersArgumentPlayerJSON();
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsPlayersArgumentPlayerAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected override void handle_result(SportsPlayersArgumentJSON new_result)
          {
            handle_result((SportsPlayersArgumentPlayerJSON )new_result);
          }
        protected void finish(SportsPlayersArgumentPlayerJSON result)
          {
        ...
        protected abstract void handle_result(SportsPlayersArgumentPlayerJSON new_result);
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorPlayerLeague = new SportsLeagueCodeJSON.HoldingGenerator("field \"PlayerLeague\" of the SportsPlayersArgumentPlayer class", ignore_extras);
    ...
    public new class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsPlayersArgumentPlayerJSON  result)
          {
//@@@            Debug.Assert(!have_value);
        ...
        public SportsPlayersArgumentPlayerJSON value;
      };
    public new class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsPlayersArgumentPlayerJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsPlayersArgumentPlayerJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsPlayersArgumentPlayerJSON> value;
  };
  };
