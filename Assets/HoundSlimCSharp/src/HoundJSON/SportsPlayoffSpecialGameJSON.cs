                            ...
                            switch (chars[3])
                              {
                                ...
                                case 'C':
                                    ...
                                    break;
                                case 'S':
                                    if ((String.Compare(chars, 4, "tanleyCup", 0, 9, false) == 0) && (chars.Length == 13))
                            ...
                            switch (json_string.getData()[3])
                              {
                                ...
                                case 'C':
                                    ...
                                    break;
                                case 'S':
                                    if ((String.Compare(json_string.getData(), 4, "tanleyCup", 0, 9, false) == 0) && (json_string.getData().Length == 13))
                                          {
                                            the_open_enum.in_known_list = true;
