/* file "SportsLeagueLeadersArgumentJSON.cs" */
...
public class SportsLeagueLeadersArgumentJSON : JSONBase
  {
    public struct TypeArgumentData
      {
        ...
        public struct Utype
          {
            [FieldOffset(0)]
            public SportsSeasonJSON  choice0;
            [FieldOffset(0)]
            public SportsStatsArgumentTypeModifierJSON  choice1;
          };
        public Utype u;
      };
    ...
    private void  fromJSONArgumentData(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (!or_done)
            throw new Exception("The value for field ArgumentData of SportsLeagueLeadersArgumentJSON is not one of the allowed values.");
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field ArgumentID of SportsLeagueLeadersArgumentJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field ArgumentID of SportsLeagueLeadersArgumentJSON is not an integer.");
              }
    ...
    public SportsLeagueLeadersArgumentJSON()
      {
    ...
    public virtual int extraSportsLeagueLeadersArgumentComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsLeagueLeadersArgumentComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsLeagueLeadersArgumentComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsLeagueLeadersArgumentLookup(string field_name)
      {
    ...
    public void setArgumentID(BigInteger new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field ArgumentID of SportsLeagueLeadersArgumentJSON is less than the lower bound (0) for that field.");
    ...
    public virtual void extraSportsLeagueLeadersArgumentAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsLeagueLeadersArgumentSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static SportsLeagueLeadersArgumentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsLeagueLeadersArgumentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsLeagueLeadersArgument", ignore_extras);
    ...
    public static SportsLeagueLeadersArgumentJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsLeagueLeadersArgumentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsLeagueLeadersArgumentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsLeagueLeadersArgument", ignore_extras);
    ...
    public static SportsLeagueLeadersArgumentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsLeagueLeadersArgumentJSON from_text(string text, bool ignore_extras)
      {
        SportsLeagueLeadersArgumentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsLeagueLeadersArgument", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsLeagueLeadersArgumentJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static SportsLeagueLeadersArgumentJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsLeagueLeadersArgumentJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsLeagueLeadersArgument", ignore_extras);
    ...
    private abstract class FieldGeneratorArgumentData : JSONParallelGenerator
          {
            private SportsSeasonJSON.HoldingGenerator field0;
            private SportsStatsArgumentTypeModifierJSON.HoldingGenerator field1;
            ...
            public FieldGeneratorArgumentData(bool ignore_extras)
              {
                    field0 = new SportsSeasonJSON.HoldingGenerator("option 0 of field \"ArgumentData\"", ignore_extras);
                    field1 = new SportsStatsArgumentTypeModifierJSON.HoldingGenerator("option 1 of field \"ArgumentData\"", ignore_extras);
    ...
    private class FieldHoldingArrayGeneratorArgumentData : JSONArrayGenerator
  {
    ...
    private class FieldHoldingArrayGeneratorArgumentID : JSONHoldingIntegerLowerBoundOnlyArrayGenerator
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsLeagueLeadersArgumentAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsLeagueLeadersArgumentJSON result)
          {
        ...
        protected abstract void handle_result(SportsLeagueLeadersArgumentJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorArgumentData = new FieldHoldingGeneratorArgumentData("field \"ArgumentData\" of the SportsLeagueLeadersArgument class", ignore_extras);
            fieldGeneratorArgumentID = new FieldHoldingGeneratorArgumentID("field \"ArgumentID\" of the SportsLeagueLeadersArgument class");
        ...
        public Generator()
          {
            fieldGeneratorArgumentData = new FieldHoldingGeneratorArgumentData("field \"ArgumentData\" of the SportsLeagueLeadersArgument class", false);
            fieldGeneratorArgumentID = new FieldHoldingGeneratorArgumentID("field \"ArgumentID\" of the SportsLeagueLeadersArgument class");
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsLeagueLeadersArgumentJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SportsLeagueLeadersArgumentJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsLeagueLeadersArgumentJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<SportsLeagueLeadersArgumentJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsLeagueLeadersArgumentJSON> value;
  };
  };
