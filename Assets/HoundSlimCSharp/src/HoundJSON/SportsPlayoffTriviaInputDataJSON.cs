...
public class SportsPlayoffTriviaInputDataJSON : JSONBase
  {
    ...
    public enum TypeOutcomeKnownValues
      {
        Outcome_Won,
        Outcome_Lost,
        Outcome_Appeared,
    ...
    public struct TypeOutcome
      {
        public bool in_known_list;
        public string string_value;
        public TypeOutcomeKnownValues list_value;
      };

    public static TypeOutcomeKnownValues  stringToOutcome(string chars)
      {
        switch (chars[0])
          {
            case 'A':
                if ((String.Compare(chars, 1, "ppeared", 0, 7, false) == 0) && (chars.Length == 8))
                    return TypeOutcomeKnownValues.Outcome_Appeared;
                break;
            case 'F':
                if ((String.Compare(chars, 1, "aced", 0, 4, false) == 0) && (chars.Length == 5))
                    return TypeOutcomeKnownValues.Outcome_Faced;
                break;
            case 'L':
                if ((String.Compare(chars, 1, "ost", 0, 3, false) == 0) && (chars.Length == 4))
                    return TypeOutcomeKnownValues.Outcome_Lost;
                break;
            case 'W':
                if ((String.Compare(chars, 1, "on", 0, 2, false) == 0) && (chars.Length == 3))
                    return TypeOutcomeKnownValues.Outcome_Won;
                break;
            default:
                break;
          }
        return TypeOutcomeKnownValues.Outcome__none;
      }

    public static string  stringFromOutcome(TypeOutcomeKnownValues the_enum)
      {
        switch (the_enum)
          {
            case TypeOutcomeKnownValues.Outcome_Won:
                return "Won";
            case TypeOutcomeKnownValues.Outcome_Lost:
                return "Lost";
            case TypeOutcomeKnownValues.Outcome_Appeared:
                return "Appeared";
            case TypeOutcomeKnownValues.Outcome_Faced:
                return "Faced";
            default:
                Debug.Assert(false);
                return null;
        ...
        switch (chars[0])
          {
            ...
            case 'P':
                ...
                break;
            case 'Q':
                if ((String.Compare(chars, 1, "ueryIncomplete", 0, 14, false) == 0) && (chars.Length == 15))
                    return TypeErrorKnownValues.Error_QueryIncomplete;
                break;
            case 'T':
                if ((String.Compare(chars, 1, "eamMismatch", 0, 11, false) == 0) && (chars.Length == 12))
                    return TypeErrorKnownValues.Error_TeamMismatch;
                break;
            default:
                break;
          }
        ...
        switch (the_enum)
          {
            ...
            case TypeErrorKnownValues.Error_QueryIncomplete:
                return "QueryIncomplete";
            case TypeErrorKnownValues.Error_TeamMismatch:
                return "TeamMismatch";
    ...
    private TypeOutcome storeOutcome;
    ...
    private void  fromJSONOutcome(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Outcome of SportsPlayoffTriviaInputDataJSON is not a string.");
        TypeOutcome the_open_enum = new TypeOutcome();
        switch (json_string.getData()[0])
          {
            case 'A':
                if ((String.Compare(json_string.getData(), 1, "ppeared", 0, 7, false) == 0) && (json_string.getData().Length == 8))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeOutcomeKnownValues.Outcome_Appeared;
                        goto open_enum_is_done;
                      }
                break;
            case 'F':
                if ((String.Compare(json_string.getData(), 1, "aced", 0, 4, false) == 0) && (json_string.getData().Length == 5))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeOutcomeKnownValues.Outcome_Faced;
                        goto open_enum_is_done;
                      }
                break;
            case 'L':
                if ((String.Compare(json_string.getData(), 1, "ost", 0, 3, false) == 0) && (json_string.getData().Length == 4))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeOutcomeKnownValues.Outcome_Lost;
                        goto open_enum_is_done;
                      }
                break;
            case 'W':
                if ((String.Compare(json_string.getData(), 1, "on", 0, 2, false) == 0) && (json_string.getData().Length == 3))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeOutcomeKnownValues.Outcome_Won;
                        goto open_enum_is_done;
                      }
                break;
            default:
        ...
        switch (json_string.getData()[0])
          {
            ...
            case 'P':
                ...
                break;
            case 'Q':
                if ((String.Compare(json_string.getData(), 1, "ueryIncomplete", 0, 14, false) == 0) && (json_string.getData().Length == 15))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeErrorKnownValues.Error_QueryIncomplete;
                        goto open_enum_is_done;
                      }
                break;
            case 'T':
                if ((String.Compare(json_string.getData(), 1, "eamMismatch", 0, 11, false) == 0) && (json_string.getData().Length == 12))
                      {
                        the_open_enum.in_known_list = true;
                        the_open_enum.list_value = TypeErrorKnownValues.Error_TeamMismatch;
                        goto open_enum_is_done;
                      }
                break;
            default:
    ...
    private void  fromJSONSeriesIndices(JSONValue json_value, bool ignore_extras)
      {
        ...
        initSeriesIndices();
        for (int num3 = 0; num3 < vector_SeriesIndices1.Count; ++num3)
            appendSeriesIndices(vector_SeriesIndices1[num3]);
    ...
    public void setOutcome(TypeOutcome new_value)
      {
        flagHasOutcome = true;
    ...
    public void setOutcome(string chars)
      {
        ...
        TypeOutcome new_value = new TypeOutcome();
        if (known == TypeOutcomeKnownValues.Outcome__none)
          {
            new_value.in_known_list = false;
            new_value.string_value = chars;
          }
    ...
    public void setOutcome(TypeOutcomeKnownValues new_value)
      {
        TypeOutcome new_full_value = new TypeOutcome();
        Debug.Assert(new_value != TypeOutcomeKnownValues.Outcome__none);
        new_full_value.in_known_list = true;
        new_full_value.list_value = new_value;
        ...
        if (flagHasSeriesIndices)
          {
            ...
            handler.start_array();
            for (int num3 = 0; num3 < storeSeriesIndices.Count; ++num3)
              {
                handler.number_value(storeSeriesIndices[num3]);
              }
            handler.finish_array();
          }
        if (flagHasGamesIndices)
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorType : JSONArrayGenerator
  {
    ...
    private abstract class FieldGeneratorOutcome : JSONStringGenerator
          {
            protected FieldGeneratorOutcome(string what)
              {
                set_what(what);
              }
            protected FieldGeneratorOutcome()
              {
              }
            protected override void handle_result(string result)
              {
            ...
            protected abstract void handle_result(TypeOutcome result);
          };
    private class FieldHoldingGeneratorOutcome : FieldGeneratorOutcome
  {
    protected override void handle_result(TypeOutcome result)
      {
//@@@        Debug.Assert(!have_value);
        have_value = true;
        value = result;
    ...
    public FieldHoldingGeneratorOutcome(String what)
      {
        have_value = false;
        base.set_what(what);
      }
    ...
    public bool have_value;
    public TypeOutcome value;
  };
    private class FieldHoldingArrayGeneratorOutcome : JSONArrayGenerator
  {
    protected class ElementHandler : FieldGeneratorOutcome
      {
        private FieldHoldingArrayGeneratorOutcome top;
        ...
        public ElementHandler(FieldHoldingArrayGeneratorOutcome init_top)
          {
            top = init_top;
          }
      };
    ...
    protected virtual void handle_result(List<TypeOutcome> result)
      {
      }

    public FieldHoldingArrayGeneratorOutcome(string what)
      {
        element_handler = new ElementHandler(this);
        have_value = false;
        value = new List<TypeOutcome>();
        base.set_what(what);
      }
    public FieldHoldingArrayGeneratorOutcome()
      {
        element_handler = new ElementHandler(this);
        have_value = false;
        value = new List<TypeOutcome>();
    ...
    public bool have_value;
    public List<TypeOutcome> value;
  };
        private FieldHoldingGeneratorOutcome fieldGeneratorOutcome;
            ...
            switch (field_name[0])
              {
                ...
                case 'G':
                    ...
                    break;
                case 'I':
                    if ((String.Compare(field_name, 1, "sPlayoffsGeneral", 0, 16, false) == 0) && (field_name.Length == 17))
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorOutcome = new FieldHoldingGeneratorOutcome("field \"Outcome\" of the SportsPlayoffTriviaInputData class");
