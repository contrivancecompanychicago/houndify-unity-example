    ...
    private void  fromJSONOutputOverrideDiagnostics(JSONValue json_value, bool ignore_extras)
      {
        ...
        for (int num3 = 0; num3 < vector_OutputOverrideDiagnostics1.Count; ++num3)
            appendOutputOverrideDiagnostics(vector_OutputOverrideDiagnostics1[num3]);
    ...
    private void  fromJSONUploadedTerrierDiagnostics(JSONValue json_value, bool ignore_extras)
      {
        ...
        for (int num4 = 0; num4 < vector_UploadedTerrierDiagnostics1.Count; ++num4)
            appendUploadedTerrierDiagnostics(vector_UploadedTerrierDiagnostics1[num4]);
    ...
    private void  fromJSONRequiredFeatures(JSONValue json_value, bool ignore_extras)
      {
        ...
        for (int num5 = 0; num5 < vector_RequiredFeatures1.Count; ++num5)
            appendRequiredFeatures(vector_RequiredFeatures1[num5]);
        ...
        if (flagHasOutputOverrideDiagnostics)
          {
            ...
            handler.start_array();
            for (int num3 = 0; num3 < storeOutputOverrideDiagnostics.Count; ++num3)
              {
        ...
        if (flagHasUploadedTerrierDiagnostics)
          {
            ...
            handler.start_array();
            for (int num4 = 0; num4 < storeUploadedTerrierDiagnostics.Count; ++num4)
              {
        ...
        if (flagHasRequiredFeatures)
          {
            ...
            handler.start_array();
            for (int num5 = 0; num5 < storeRequiredFeatures.Count; ++num5)
              {
    ...
    switch (key[0])
      {
            ...
            switch (key[1])
              {
                ...
                case 'n':
                    ...
                    break;
                case 'r':
                    if ((String.Compare(key, 2, "ithCommand", 0, 10, false) == 0) && (key.Length == 12))
            ...
            switch (key[1])
              {
                case 'e':
                    switch (key[2])
                      {
                        case 'l':
                            if (String.Compare(key, 3, "ete", 0, 3, false) == 0)
                              {
                                switch (key[6])
                                  {
                                    case 'I':
                                        if ((String.Compare(key, 7, "nputOverride", 0, 12, false) == 0) && (key.Length == 19))
                                            return new DeleteInputOverrideCommandJSON();
                                        break;
                                    case 'O':
                                        if ((String.Compare(key, 7, "utputOverride", 0, 13, false) == 0) && (key.Length == 20))
                                            return new DeleteOutputOverrideCommandJSON();
                                        break;
                                    default:
                                        break;
                                  }
                            ...
                            break;
                        case 'v':
                            if ((String.Compare(key, 3, "iceControlCommand", 0, 17, false) == 0) && (key.Length == 20))
                              {
                    ...
                    switch (key[2])
                      {
                        ...
                        case 's':
                            switch (key[3])
                              {
                                case 'a':
                                    if (String.Compare(key, 4, "mbiguate", 0, 8, false) == 0)
                                      {
                                        switch (key[12])
                                          {
                                            case 'C':
                                    ...
                                    break;
                                case 'p':
                                    if ((String.Compare(key, 4, "layMap", 0, 6, false) == 0) && (key.Length == 10))
                                        return new DisplayMapCommandJSON();
                                    break;
                                default:
                                    break;
                              }
                ...
                switch (key[6])
                  {
                    case 'B':
                        ...
                        break;
                    case 'S':
                        if ((String.Compare(key, 7, "tatusCommand", 0, 12, false) == 0) && (key.Length == 19))
            ...
            switch (key[1])
              {
                ...
                case 'o':
                    ...
                    break;
                case 'u':
                    if (String.Compare(key, 2, "sic", 0, 3, false) == 0)
                      {
                        switch (key[5])
                          {
                            case 'C':
            ...
            switch (key[1])
              {
                case 'a':
                    ...
                    break;
                case 'e':
                    if (String.Compare(key, 2, "ad", 0, 2, false) == 0)
                      {
                        switch (key[4])
                          {
                            case 'I':
                                if ((String.Compare(key, 5, "nputOverride", 0, 12, false) == 0) && (key.Length == 17))
                                    return new ReadInputOverrideCommandJSON();
                                break;
                            case 'O':
                                if ((String.Compare(key, 5, "utputOverride", 0, 13, false) == 0) && (key.Length == 18))
                                    return new ReadOutputOverrideCommandJSON();
                                break;
                            default:
                                break;
                          }
            ...
            switch (key[1])
              {
                case 'M':
                    ...
                    break;
                case 'e':
                    if (String.Compare(key, 2, "t", 0, 1, false) == 0)
                      {
                        switch (key[3])
                          {
                            case 'I':
                                if ((String.Compare(key, 4, "nputOverride", 0, 12, false) == 0) && (key.Length == 16))
                                    return new SetInputOverrideCommandJSON();
                                break;
                            case 'O':
                                if ((String.Compare(key, 4, "utputOverride", 0, 13, false) == 0) && (key.Length == 17))
                                    return new SetOutputOverrideCommandJSON();
                                break;
                            default:
                                break;
                          }
        ...
        case 'T':
            switch (key[1])
              {
                case 'e':
                    if ((String.Compare(key, 2, "rrierUpload", 0, 11, false) == 0) && (key.Length == 13))
                      {
                        JSONValue key_value = ((other_field_index == null) ? null : (other_field_index.ContainsKey("TerrierUploadCommandKind") ? other_field_index["TerrierUploadCommandKind"] : null));
                        if (key_value == null)
                            throw new Exception("The `TerrierUploadCommandKind' field is missing.");
                        JSONStringValue key_string_value = key_value.string_value();
                        if (key_string_value == null)
                            throw new Exception("The `TerrierUploadCommandKind' field has a non-string value.");
                        return TerrierUploadCommandJSON.createForKey(key_string_value.getData(), other_field_index);
                      }
                    break;
                case 'i':
                    switch (key[2])
        ...
        case 'U':
            ...
            break;
        case 'W':
            if ((String.Compare(key, 1, "ikipediaCommand", 0, 15, false) == 0) && (key.Length == 16))
