    ...
    private void  fromJSONAllResults(JSONValue json_value, bool ignore_extras)
      {
        ...
        initAllResults();
        for (int num2 = 0; num2 < vector_AllResults1.Count; ++num2)
    ...
    private void  fromJSONResultsAreFinal(JSONValue json_value, bool ignore_extras)
      {
        ...
        initResultsAreFinal();
        for (int num3 = 0; num3 < vector_ResultsAreFinal1.Count; ++num3)
    ...
    private void  fromJSONDomainUsage(JSONValue json_value, bool ignore_extras)
      {
        ...
        initDomainUsage();
        for (int num4 = 0; num4 < vector_DomainUsage1.Count; ++num4)
    ...
    public void initAllResults()
      {
        if (flagHasAllResults)
          {
            for (int num3 = 0; num3 < storeAllResults.Count; ++num3)
              {
              }
          }
    ...
    public void unsetAllResults()
      {
        if (flagHasAllResults)
          {
            for (int num4 = 0; num4 < storeAllResults.Count; ++num4)
              {
              }
          }
        flagHasAllResults = false;
    ...
    public void initDomainUsage()
      {
        if (flagHasDomainUsage)
          {
            for (int num5 = 0; num5 < storeDomainUsage.Count; ++num5)
              {
              }
          }
    ...
    public void unsetDomainUsage()
      {
        if (flagHasDomainUsage)
          {
            for (int num6 = 0; num6 < storeDomainUsage.Count; ++num6)
              {
              }
          }
        flagHasDomainUsage = false;
        ...
        if (flagHasDomainUsage)
          {
            ...
            handler.start_array();
            for (int num3 = 0; num3 < storeDomainUsage.Count; ++num3)
              {
                if (partial_allowed)
                    storeDomainUsage[num3].write_partial_as_json(handler);
                else
