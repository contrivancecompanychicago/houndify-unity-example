        ...
        switch (field_name[0])
          {
            case 'C':
                ...
                break;
            case 'D':
                if ((String.Compare(field_name, 1, "raw", 0, 3, false) == 0) && (field_name.Length == 4))
            ...
            case 'I':
                ...
                break;
            case 'T':
                if ((String.Compare(field_name, 1, "ie", 0, 2, false) == 0) && (field_name.Length == 3))
        ...
        switch (key[0])
          {
            case 'C':
                ...
                break;
            case 'D':
                if ((String.Compare(key, 1, "raw", 0, 3, false) == 0) && (key.Length == 4))
                    {
            ...
            case 'I':
                ...
                break;
            case 'T':
                if ((String.Compare(key, 1, "ie", 0, 2, false) == 0) && (key.Length == 3))
                    {
