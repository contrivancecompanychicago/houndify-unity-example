    ...
    private void  fromJSONRequestedAttribute(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field RequestedAttribute of WeatherInformationNuggetIntentJSON is not a string.");
    ...
    private void  fromJSONRequestedAttributeAction(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field RequestedAttributeAction of WeatherInformationNuggetIntentJSON is not a string.");
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Units of WeatherInformationNuggetIntentJSON is not a string.");
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorRequestedAttribute = new JSONHoldingStringGenerator("field \"RequestedAttribute\" of the WeatherInformationNuggetIntent class");
            fieldGeneratorRequestedAttributeAction = new FieldHoldingGeneratorRequestedAttributeAction("field \"RequestedAttributeAction\" of the WeatherInformationNuggetIntent class");
            ...
            fieldGeneratorUnits = new JSONHoldingStringGenerator("field \"Units\" of the WeatherInformationNuggetIntent class");
