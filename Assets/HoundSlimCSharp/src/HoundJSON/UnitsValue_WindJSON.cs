    ...
    private void  fromJSONFormat(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Format of UnitsValue_WindJSON is not a string.");
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Units of UnitsValue_WindJSON is not a string.");
