...
public class AMChannelCommandIntentJSON : RadioCommandIntentJSON
    ...
    public void setChannel(short new_value)
      {
        flagHasChannel = true;
        if (new_value < 530)
            throw new Exception("The value for field Channel of AMChannelCommandIntentJSON is less than the lower bound (530) for that field.");
        if (new_value > 1710)
            throw new Exception("The value for field Channel of AMChannelCommandIntentJSON is greater than the upper bound (1710) for that field.");
    ...
    public static new AMChannelCommandIntentJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    private class FieldHoldingGeneratorChannel : JSONHoldingIntegerRangeGenerator
          {
            public FieldHoldingGeneratorChannel(String what) : base(what, 530, 1710)
              {
              }
          };
    private class FieldHoldingArrayGeneratorChannel : JSONHoldingIntegerRangeArrayGenerator
          {
            public FieldHoldingArrayGeneratorChannel(String what) : base(what, 530, 1710)
              {
              }
          };
