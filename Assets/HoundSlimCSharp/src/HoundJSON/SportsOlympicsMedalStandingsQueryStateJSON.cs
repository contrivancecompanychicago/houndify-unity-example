/* file "SportsOlympicsMedalStandingsQueryStateJSON.cs" */
...
public class SportsOlympicsMedalStandingsQueryStateJSON : JSONBase
  {
    private bool flagHasArgumentSets;
    private List< List< SportsOlympicsMedalStandingsArgumentJSON  > > storeArgumentSets;
    ...
    public SportsOlympicsMedalStandingsQueryStateJSON()
      {
        flagHasArgumentSets = false;
        storeArgumentSets = new List< List< SportsOlympicsMedalStandingsArgumentJSON  > >();
    ...
    public List< SportsOlympicsMedalStandingsArgumentJSON  >  elementOfArgumentSets(int element_num)
      {
        Debug.Assert(flagHasArgumentSets);
        return storeArgumentSets[element_num];
      }

    public List< List< SportsOlympicsMedalStandingsArgumentJSON  > >  getArgumentSets()
      {
        Debug.Assert(flagHasArgumentSets);
    ...
    public virtual int extraSportsOlympicsMedalStandingsQueryStateComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsOlympicsMedalStandingsQueryStateComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsOlympicsMedalStandingsQueryStateComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsOlympicsMedalStandingsQueryStateLookup(string field_name)
      {
    ...
    public void appendArgumentSets(List< SportsOlympicsMedalStandingsArgumentJSON  > to_append)
      {
        if (!flagHasArgumentSets)
          {
            flagHasArgumentSets = true;
    ...
    public virtual void extraSportsOlympicsMedalStandingsQueryStateAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsOlympicsMedalStandingsQueryStateSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static SportsOlympicsMedalStandingsQueryStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsMedalStandingsQueryStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsQueryState", ignore_extras);
    ...
    public static SportsOlympicsMedalStandingsQueryStateJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsOlympicsMedalStandingsQueryStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsOlympicsMedalStandingsQueryStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsQueryState", ignore_extras);
    ...
    public static SportsOlympicsMedalStandingsQueryStateJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsOlympicsMedalStandingsQueryStateJSON from_text(string text, bool ignore_extras)
      {
        SportsOlympicsMedalStandingsQueryStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsQueryState", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsOlympicsMedalStandingsQueryStateJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static SportsOlympicsMedalStandingsQueryStateJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsOlympicsMedalStandingsQueryStateJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsOlympicsMedalStandingsQueryState", ignore_extras);
  ...
  {
    protected class ElementHandler : SportsOlympicsMedalStandingsArgumentJSON.HoldingArrayGenerator
      {
        private FieldHoldingArrayGeneratorArgumentSets top;

        protected override void handle_result(List< SportsOlympicsMedalStandingsArgumentJSON  > result)
          {
    ...
    protected virtual void handle_result(List<List< SportsOlympicsMedalStandingsArgumentJSON  >> result)
      {
      }
    ...
    public FieldHoldingArrayGeneratorArgumentSets(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<List< SportsOlympicsMedalStandingsArgumentJSON  >>();
        base.set_what(what);
      }
    ...
    public List<List< SportsOlympicsMedalStandingsArgumentJSON  >> value;
  };
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsOlympicsMedalStandingsQueryStateAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsOlympicsMedalStandingsQueryStateJSON result)
          {
            if (fieldGeneratorArgumentSets.have_value)
              {
                ...
                for (int num = 0; num < count; ++num)
                  {
                    List< SportsOlympicsMedalStandingsArgumentJSON  > unwrapped0 = new List< SportsOlympicsMedalStandingsArgumentJSON  >();
        ...
        protected abstract void handle_result(SportsOlympicsMedalStandingsQueryStateJSON new_result);
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorArgumentSets = new FieldHoldingArrayGeneratorArgumentSets("field \"ArgumentSets\" of the SportsOlympicsMedalStandingsQueryState class", ignore_extras);
        ...
        public Generator()
          {
            fieldGeneratorArgumentSets = new FieldHoldingArrayGeneratorArgumentSets("field \"ArgumentSets\" of the SportsOlympicsMedalStandingsQueryState class", false);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsOlympicsMedalStandingsQueryStateJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SportsOlympicsMedalStandingsQueryStateJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsOlympicsMedalStandingsQueryStateJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        element_handler = new ElementHandler(this, ignore_extras);
        have_value = false;
        value = new List<SportsOlympicsMedalStandingsQueryStateJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsOlympicsMedalStandingsQueryStateJSON> value;
  };
  };
