                        ...
                        switch (field_name[1])
                          {
                            case 'h':
                                ...
                                break;
                            case 'o':
                                if ((String.Compare(field_name, 2, "ntactNumberChoices", 0, 18, false) == 0) && (field_name.Length == 20))
            ...
            public Generator(bool ignore_extras)
              {
                ...
                fieldGeneratorContactNumberChoices = new ContactNumberChoicesJSON.HoldingGenerator("field \"ContactNumberChoices\" of the TypeNativeData class", ignore_extras);
            ...
            public Generator()
              {
                ...
                fieldGeneratorContactNumberChoices = new ContactNumberChoicesJSON.HoldingGenerator("field \"ContactNumberChoices\" of the TypeNativeData class", false);
                fieldGeneratorPreviousMessage = new JSONHoldingStringGenerator("field \"PreviousMessage\" of the TypeNativeData class");
                fieldGeneratorSpokenBody = new JSONHoldingStringGenerator("field \"SpokenBody\" of the TypeNativeData class");
                fieldGeneratorWrittenBody = new JSONHoldingStringGenerator("field \"WrittenBody\" of the TypeNativeData class");
                fieldGeneratorErrorMessage = new JSONHoldingStringGenerator("field \"ErrorMessage\" of the TypeNativeData class");
            ...
            public void set_allow_incomplete(bool new_allow_incomplete)
              {
                ...
                fieldGeneratorContactNumberChoices.set_allow_incomplete(new_allow_incomplete);
              }
            public void set_allow_unpolished(bool new_allow_unpolished)
              {
                allow_unpolished = new_allow_unpolished;
                fieldGeneratorContactNumberChoices.set_allow_unpolished(new_allow_unpolished);
              }
          };
    ...
    public new abstract class Generator : DisambiguateCommandJSON.Generator
      {
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the SMSDisambiguatePhoneNumbersCommand class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            set_what("the SMSDisambiguatePhoneNumbersCommand class");
          }
        public Generator() : base(false)
          {
            fieldGeneratorNativeData = new TypeNativeDataJSON.HoldingGenerator("field \"NativeData\" of the SMSDisambiguatePhoneNumbersCommand class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the SMSDisambiguatePhoneNumbersCommand class");
          }
