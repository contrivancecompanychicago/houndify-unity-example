...
public class DictionarySearchTermJSON : JSONBase
  {
    ...
    public virtual int extraDictionarySearchTermComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraDictionarySearchTermComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraDictionarySearchTermComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraDictionarySearchTermLookup(string field_name)
      {
    ...
    public virtual void extraDictionarySearchTermAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraDictionarySearchTermSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        protected override void finish()
          {
            DictionarySearchTermJSON result = new DictionarySearchTermJSON();
        ...
        protected virtual JSONHandler start_known_field(string field_name)
          {
            if ((String.Compare(field_name, 0, "Term", 0, 4, false) == 0) && (field_name.Length == 4))
