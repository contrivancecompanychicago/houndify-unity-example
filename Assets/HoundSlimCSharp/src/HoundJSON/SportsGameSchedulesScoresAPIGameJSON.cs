/* file "SportsGameSchedulesScoresAPIGameJSON.cs" */
...
public class SportsGameSchedulesScoresAPIGameJSON : JSONBase
  {
    ...
    private void  fromJSONTeams(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_array1 == null)
            throw new Exception("The value for field Teams of SportsGameSchedulesScoresAPIGameJSON is not an array.");
        int count1 = json_array1.componentCount();
        if (count1 < 2)
            throw new Exception("The value for field Teams of SportsGameSchedulesScoresAPIGameJSON has too few elements.");
    ...
    private void  fromJSONGameStatus(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field GameStatus of SportsGameSchedulesScoresAPIGameJSON is not a string.");
        ...
        if (json_integer == null)
          {
            ...
            if (json_rational == null)
              {
                throw new Exception("The value for field QuarterInningPeriod of SportsGameSchedulesScoresAPIGameJSON is not a number.");
              }
            if (!(json_rational.isInteger()))
              {
                throw new Exception("The value for field QuarterInningPeriod of SportsGameSchedulesScoresAPIGameJSON is not an integer.");
              }
    ...
    private void  fromJSONQuarterInningPeriodClock(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field QuarterInningPeriodClock of SportsGameSchedulesScoresAPIGameJSON is not a string.");
    ...
    private void  fromJSONBroadcastNetwork(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field BroadcastNetwork of SportsGameSchedulesScoresAPIGameJSON is not a string.");
    ...
    private void  fromJSONSportsResultType(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field SportsResultType of SportsGameSchedulesScoresAPIGameJSON is not a string.");
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field Playoffs of SportsGameSchedulesScoresAPIGameJSON is not true for false.");
              }
          }
    ...
    private void  fromJSONPlayoffGame(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field PlayoffGame of SportsGameSchedulesScoresAPIGameJSON is not a string.");
        ...
        if (json_true != null)
        ...
        else
          {
            ...
            if (json_false != null)
              ...
              {
                throw new Exception("The value for field PreSeason of SportsGameSchedulesScoresAPIGameJSON is not true for false.");
              }
          }
    ...
    private void  fromJSONGameID(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field GameID of SportsGameSchedulesScoresAPIGameJSON is not a string.");
    ...
    public SportsGameSchedulesScoresAPIGameJSON()
      {
        flagHasTeams = false;
    ...
    public virtual int extraSportsGameSchedulesScoresAPIGameComponentCount()
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        return extraKeys.Count;
      }
    public virtual string extraSportsGameSchedulesScoresAPIGameComponentKey(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraKeys[component_num];
      }
    public virtual JSONValue extraSportsGameSchedulesScoresAPIGameComponentValue(int component_num)
      {
        Debug.Assert(extraKeys.Count == extraValues.Count);
        Debug.Assert(component_num < extraValues.Count);
        return extraValues[component_num];
      }
    public virtual JSONValue extraSportsGameSchedulesScoresAPIGameLookup(string field_name)
      {
    ...
    public void setQuarterInningPeriod(BigInteger new_value)
      {
        ...
        if (new_value < 0)
            throw new Exception("The value for field QuarterInningPeriod of SportsGameSchedulesScoresAPIGameJSON is less than the lower bound (0) for that field.");
    ...
    public virtual void extraSportsGameSchedulesScoresAPIGameAppendPair(string key, JSONValue new_component)
      {
    ...
    public virtual void extraSportsGameSchedulesScoresAPIGameSetField(string key, JSONValue new_component)
      {
        Debug.Assert(key != null);
        Debug.Assert(new_component != null);
    ...
    public static SportsGameSchedulesScoresAPIGameJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsGameSchedulesScoresAPIGameJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsGameSchedulesScoresAPIGame", ignore_extras);
    ...
    public static SportsGameSchedulesScoresAPIGameJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsGameSchedulesScoresAPIGameJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
      {
        SportsGameSchedulesScoresAPIGameJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsGameSchedulesScoresAPIGame", ignore_extras);
    ...
    public static SportsGameSchedulesScoresAPIGameJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    return from_json(json_value, ignore_extras, allow_incomplete, false);
  }
    public static SportsGameSchedulesScoresAPIGameJSON from_text(string text, bool ignore_extras)
      {
        SportsGameSchedulesScoresAPIGameJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsGameSchedulesScoresAPIGame", ignore_extras);
            JSONParse.parse_json_value(text, "Text for SportsGameSchedulesScoresAPIGameJSON", generator);
            Debug.Assert(generator.have_value);
            result = generator.value;
          };
        return result;
      }
    public static SportsGameSchedulesScoresAPIGameJSON from_file(TextReader fp, string file_name, bool ignore_extras)
      {
        SportsGameSchedulesScoresAPIGameJSON result;
          {
            HoldingGenerator generator = new HoldingGenerator("Type SportsGameSchedulesScoresAPIGame", ignore_extras);
...
//@@@        Debug.Assert(!have_value);
    ...
    private class FieldHoldingArrayGeneratorSportsResultType : JSONArrayGenerator
  {
    ...
    public List<TypeSportsResultType> value;
        ...
        protected override void finish()
          {
            ...
            for (int extra_num = 0; extra_num < extra_count; ++extra_num)
              {
                result.extraSportsGameSchedulesScoresAPIGameAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
              }
        ...
        protected void finish(SportsGameSchedulesScoresAPIGameJSON result)
          {
        ...
        protected abstract void handle_result(SportsGameSchedulesScoresAPIGameJSON new_result);
            ...
            switch (field_name[0])
              {
                                    ...
                                    switch (field_name[7])
                                      {
                                        case 'r':
                                            ...
                                            break;
                                        case 't':
                                            if ((String.Compare(field_name, 8, "us", 0, 2, false) == 0) && (field_name.Length == 10))
                ...
                case 'P':
                    switch (field_name[1])
                      {
                        case 'l':
                            if (String.Compare(field_name, 2, "ayoff", 0, 5, false) == 0)
                              {
                                switch (field_name[7])
                                  {
                                    case 'G':
                        ...
                        switch (field_name[5])
                          {
                            case 'I':
                                ...
                                break;
                            case 's':
                                if ((String.Compare(field_name, 6, "ResultType", 0, 10, false) == 0) && (field_name.Length == 16))
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorTeams = new SportsTeamJSON.HoldingArrayGenerator("field \"Teams\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras);
            fieldGeneratorGameStartTime = new DateAndOrTimeJSON.HoldingGenerator("field \"GameStartTime\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras);
            fieldGeneratorGameStatus = new FieldHoldingGeneratorGameStatus("field \"GameStatus\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorQuarterInningPeriod = new FieldHoldingGeneratorQuarterInningPeriod("field \"QuarterInningPeriod\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorQuarterInningPeriodClock = new JSONHoldingStringGenerator("field \"QuarterInningPeriodClock\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorVenue = new SportsVenueJSON.HoldingGenerator("field \"Venue\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras);
            fieldGeneratorBroadcastNetwork = new JSONHoldingStringGenerator("field \"BroadcastNetwork\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorSportsResultType = new FieldHoldingGeneratorSportsResultType("field \"SportsResultType\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorPlayoffs = new JSONHoldingBooleanGenerator("field \"Playoffs\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorPlayoffGame = new JSONHoldingStringGenerator("field \"PlayoffGame\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorPlayoffType = new SportsPlayoffSpecialGameJSON.HoldingGenerator("field \"PlayoffType\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras);
            fieldGeneratorTournament = new SportsTournamentJSON.HoldingGenerator("field \"Tournament\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras);
            fieldGeneratorPreSeason = new JSONHoldingBooleanGenerator("field \"PreSeason\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorGameID = new JSONHoldingStringGenerator("field \"GameID\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorSportImage = new SportsSportImageJSON.HoldingGenerator("field \"SportImage\" of the SportsGameSchedulesScoresAPIGame class", ignore_extras);
        ...
        public Generator()
          {
            fieldGeneratorTeams = new SportsTeamJSON.HoldingArrayGenerator("field \"Teams\" of the SportsGameSchedulesScoresAPIGame class", false);
            fieldGeneratorGameStartTime = new DateAndOrTimeJSON.HoldingGenerator("field \"GameStartTime\" of the SportsGameSchedulesScoresAPIGame class", false);
            fieldGeneratorGameStatus = new FieldHoldingGeneratorGameStatus("field \"GameStatus\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorQuarterInningPeriod = new FieldHoldingGeneratorQuarterInningPeriod("field \"QuarterInningPeriod\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorQuarterInningPeriodClock = new JSONHoldingStringGenerator("field \"QuarterInningPeriodClock\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorVenue = new SportsVenueJSON.HoldingGenerator("field \"Venue\" of the SportsGameSchedulesScoresAPIGame class", false);
            fieldGeneratorBroadcastNetwork = new JSONHoldingStringGenerator("field \"BroadcastNetwork\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorSportsResultType = new FieldHoldingGeneratorSportsResultType("field \"SportsResultType\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorPlayoffs = new JSONHoldingBooleanGenerator("field \"Playoffs\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorPlayoffGame = new JSONHoldingStringGenerator("field \"PlayoffGame\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorPlayoffType = new SportsPlayoffSpecialGameJSON.HoldingGenerator("field \"PlayoffType\" of the SportsGameSchedulesScoresAPIGame class", false);
            fieldGeneratorTournament = new SportsTournamentJSON.HoldingGenerator("field \"Tournament\" of the SportsGameSchedulesScoresAPIGame class", false);
            fieldGeneratorPreSeason = new JSONHoldingBooleanGenerator("field \"PreSeason\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorGameID = new JSONHoldingStringGenerator("field \"GameID\" of the SportsGameSchedulesScoresAPIGame class");
            fieldGeneratorSportImage = new SportsSportImageJSON.HoldingGenerator("field \"SportImage\" of the SportsGameSchedulesScoresAPIGame class", false);
    ...
    public class HoldingGenerator : Generator
      {
        protected override void handle_result(SportsGameSchedulesScoresAPIGameJSON  result)
          {
//@@@            Debug.Assert(!have_value);
            have_value = true;
            value = result;
        ...
        public bool have_value;
        public SportsGameSchedulesScoresAPIGameJSON value;
      };
    public class HoldingArrayGenerator : JSONArrayGenerator
  {
    ...
    protected virtual void handle_result(List<SportsGameSchedulesScoresAPIGameJSON> result)
    ...
    public HoldingArrayGenerator(string what, bool ignore_extras)
      {
        ...
        have_value = false;
        value = new List<SportsGameSchedulesScoresAPIGameJSON>();
        base.set_what(what);
      }
    ...
    public bool have_value;
    public List<SportsGameSchedulesScoresAPIGameJSON> value;
  };
  };
