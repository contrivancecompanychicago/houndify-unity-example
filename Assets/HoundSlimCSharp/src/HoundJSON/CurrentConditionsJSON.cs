    ...
    private void  fromJSONConditionsShortPhrase(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field ConditionsShortPhrase of CurrentConditionsJSON is not a string.");
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorConditionsShortPhrase = new JSONHoldingStringGenerator("field \"ConditionsShortPhrase\" of the CurrentConditions class");
            ...
            fieldGeneratorWind = new TypeWindJSON.HoldingGenerator("field \"Wind\" of the CurrentConditions class", ignore_extras);
            fieldGeneratorWindGust = new TypeWindGustJSON.HoldingGenerator("field \"WindGust\" of the CurrentConditions class", ignore_extras);
            fieldGeneratorBarometricPressure = new TypeBarometricPressureJSON.HoldingGenerator("field \"BarometricPressure\" of the CurrentConditions class", ignore_extras);
            fieldGeneratorUVIndex = new TypeUVIndexJSON.HoldingGenerator("field \"UVIndex\" of the CurrentConditions class", ignore_extras);
        ...
        public Generator()
          {
            ...
            fieldGeneratorWind = new TypeWindJSON.HoldingGenerator("field \"Wind\" of the CurrentConditions class", false);
            fieldGeneratorWindGust = new TypeWindGustJSON.HoldingGenerator("field \"WindGust\" of the CurrentConditions class", false);
            fieldGeneratorBarometricPressure = new TypeBarometricPressureJSON.HoldingGenerator("field \"BarometricPressure\" of the CurrentConditions class", false);
            fieldGeneratorUVIndex = new TypeUVIndexJSON.HoldingGenerator("field \"UVIndex\" of the CurrentConditions class", false);
            fieldGeneratorCloudinessPct = new FieldHoldingGeneratorCloudinessPct("field \"CloudinessPct\" of the CurrentConditions class");
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the CurrentConditions class");
            allow_incomplete = false;
