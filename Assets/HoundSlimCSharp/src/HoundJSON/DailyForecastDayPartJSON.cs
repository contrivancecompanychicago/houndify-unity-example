...
public class DailyForecastDayPartJSON : JSONBase
  {
        ...
        private void  fromJSONDirectionAbbreviation(JSONValue json_value, bool ignore_extras)
          {
            ...
            JSONStringValue json_string = json_value.string_value();
            if (json_string == null)
                throw new Exception("The value for field DirectionAbbreviation of TypeWindGustJSON is not a string.");
            setDirectionAbbreviation(json_string.getData());
          }
        ...
        private void  fromJSONDirectionText(JSONValue json_value, bool ignore_extras)
          {
            ...
            JSONStringValue json_string = json_value.string_value();
            if (json_string == null)
                throw new Exception("The value for field DirectionText of TypeWindGustJSON is not a string.");
            setDirectionText(json_string.getData());
          }
            ...
            if (json_integer == null)
              {
                ...
                if (json_rational == null)
                  {
                    throw new Exception("The value for field DirectionDegrees of TypeWindGustJSON is not a number.");
                  }
                if (!(json_rational.isInteger()))
                  {
                    throw new Exception("The value for field DirectionDegrees of TypeWindGustJSON is not an integer.");
                  }
                extracted_integer = (short)(json_rational.getLongInt())            ;
              }
            else
        ...
        public void setDirectionDegrees(short new_value)
          {
            flagHasDirectionDegrees = true;
            if (new_value < 0)
                throw new Exception("The value for field DirectionDegrees of TypeWindGustJSON is less than the lower bound (0) for that field.");
            if (new_value > 360)
                throw new Exception("The value for field DirectionDegrees of TypeWindGustJSON is greater than the upper bound (360) for that field.");
            storeDirectionDegrees = new_value;
          }
        public void unsetDirectionDegrees()
          {
            ...
            public Generator(bool ignore_extras)
              {
                ...
                fieldGeneratorDirectionAbbreviation = new JSONHoldingStringGenerator("field \"DirectionAbbreviation\" of the TypeWindGust class");
                fieldGeneratorDirectionText = new JSONHoldingStringGenerator("field \"DirectionText\" of the TypeWindGust class");
                fieldGeneratorDirectionDegrees = new FieldHoldingGeneratorDirectionDegrees("field \"DirectionDegrees\" of the TypeWindGust class");
                unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
    ...
    private string storeIconPhrase;
    ...
    private void  fromJSONIconPhrase(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field IconPhrase of DailyForecastDayPartJSON is not a string.");
        setIconPhrase(json_string.getData());
      }
    ...
    public void setIconPhrase(string new_value)
      {
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private JSONHoldingStringGenerator fieldGeneratorIconPhrase;
                        ...
                        switch (field_name[2])
                          {
                            case 'e':
                                ...
                                break;
                            case 'o':
                                if ((String.Compare(field_name, 3, "nPhrase", 0, 7, false) == 0) && (field_name.Length == 10))
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorIconPhrase = new JSONHoldingStringGenerator("field \"IconPhrase\" of the DailyForecastDayPart class");
            ...
            fieldGeneratorWind = new TypeWindJSON.HoldingGenerator("field \"Wind\" of the DailyForecastDayPart class", ignore_extras);
            fieldGeneratorWindGust = new TypeWindGustJSON.HoldingGenerator("field \"WindGust\" of the DailyForecastDayPart class", ignore_extras);
        ...
        public Generator()
          {
            ...
            fieldGeneratorShortPhrase = new JSONHoldingStringGenerator("field \"ShortPhrase\" of the DailyForecastDayPart class");
            fieldGeneratorLongPhrase = new JSONHoldingStringGenerator("field \"LongPhrase\" of the DailyForecastDayPart class");
            fieldGeneratorWind = new TypeWindJSON.HoldingGenerator("field \"Wind\" of the DailyForecastDayPart class", false);
            fieldGeneratorWindGust = new TypeWindGustJSON.HoldingGenerator("field \"WindGust\" of the DailyForecastDayPart class", false);
