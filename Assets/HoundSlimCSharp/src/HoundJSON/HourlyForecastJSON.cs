    ...
    private void  fromJSONConditionsShortPhrase(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field ConditionsShortPhrase of HourlyForecastJSON is not a string.");
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorConditionsShortPhrase = new JSONHoldingStringGenerator("field \"ConditionsShortPhrase\" of the HourlyForecast class");
            ...
            fieldGeneratorUVIndex = new TypeUVIndexJSON.HoldingGenerator("field \"UVIndex\" of the HourlyForecast class", ignore_extras);
            fieldGeneratorWind = new TypeWindJSON.HoldingGenerator("field \"Wind\" of the HourlyForecast class", ignore_extras);
        ...
        public Generator()
          {
            ...
            fieldGeneratorProbabilityOfPrecipitationPct = new FieldHoldingGeneratorProbabilityOfPrecipitationPct("field \"ProbabilityOfPrecipitationPct\" of the HourlyForecast class");
            fieldGeneratorHumidityPct = new FieldHoldingGeneratorHumidityPct("field \"HumidityPct\" of the HourlyForecast class");
            fieldGeneratorUVIndex = new TypeUVIndexJSON.HoldingGenerator("field \"UVIndex\" of the HourlyForecast class", false);
            fieldGeneratorWind = new TypeWindJSON.HoldingGenerator("field \"Wind\" of the HourlyForecast class", false);
