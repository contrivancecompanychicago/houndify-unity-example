    ...
    private void  fromJSONRequestedAttribute(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field RequestedAttribute of HoundWeatherInformationNuggetIntentJSON is not a string.");
    ...
    private void  fromJSONRequestedAttributeAction(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field RequestedAttributeAction of HoundWeatherInformationNuggetIntentJSON is not a string.");
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Units of HoundWeatherInformationNuggetIntentJSON is not a string.");
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorRequestedAttribute = new JSONHoldingStringGenerator("field \"RequestedAttribute\" of the HoundWeatherInformationNuggetIntent class");
            fieldGeneratorRequestedAttributeAction = new FieldHoldingGeneratorRequestedAttributeAction("field \"RequestedAttributeAction\" of the HoundWeatherInformationNuggetIntent class");
            ...
            fieldGeneratorUnits = new JSONHoldingStringGenerator("field \"Units\" of the HoundWeatherInformationNuggetIntent class");
