...
public class DailyForecastJSON : JSONBase
  {
        ...
        private void  fromJSONDirectionAbbreviation(JSONValue json_value, bool ignore_extras)
          {
            ...
            if (json_string == null)
                throw new Exception("The value for field DirectionAbbreviation of TypeMaxWindJSON is not a string.");
        ...
        private void  fromJSONDirectionText(JSONValue json_value, bool ignore_extras)
          {
            ...
            JSONStringValue json_string = json_value.string_value();
            if (json_string == null)
                throw new Exception("The value for field DirectionText of TypeMaxWindJSON is not a string.");
            ...
            if (json_integer == null)
              {
                ...
                if (json_rational == null)
                  {
                    throw new Exception("The value for field DirectionDegrees of TypeMaxWindJSON is not a number.");
                  }
                if (!(json_rational.isInteger()))
                  {
                    throw new Exception("The value for field DirectionDegrees of TypeMaxWindJSON is not an integer.");
                  }
        ...
        public void setDirectionDegrees(short new_value)
          {
            ...
            if (new_value < 0)
                throw new Exception("The value for field DirectionDegrees of TypeMaxWindJSON is less than the lower bound (0) for that field.");
            if (new_value > 360)
                throw new Exception("The value for field DirectionDegrees of TypeMaxWindJSON is greater than the upper bound (360) for that field.");
            ...
            public Generator(bool ignore_extras)
              {
                ...
                fieldGeneratorDirectionAbbreviation = new JSONHoldingStringGenerator("field \"DirectionAbbreviation\" of the TypeMaxWind class");
                fieldGeneratorDirectionText = new JSONHoldingStringGenerator("field \"DirectionText\" of the TypeMaxWind class");
                fieldGeneratorDirectionDegrees = new FieldHoldingGeneratorDirectionDegrees("field \"DirectionDegrees\" of the TypeMaxWind class");
                unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
    ...
    public class TypeAvgWindJSON : JSONBase
      {
        private bool flagHasValue;
        private UnitsValue_WindJSON  storeValue;
        private bool flagHasDirectionAbbreviation;
        ...
        private void  fromJSONDirectionAbbreviation(JSONValue json_value, bool ignore_extras)
          {
            ...
            JSONStringValue json_string = json_value.string_value();
            if (json_string == null)
                throw new Exception("The value for field DirectionAbbreviation of TypeAvgWindJSON is not a string.");
            setDirectionAbbreviation(json_string.getData());
          }
        ...
        private void  fromJSONDirectionText(JSONValue json_value, bool ignore_extras)
          {
            ...
            JSONStringValue json_string = json_value.string_value();
            if (json_string == null)
                throw new Exception("The value for field DirectionText of TypeAvgWindJSON is not a string.");
            setDirectionText(json_string.getData());
          }
            ...
            if (json_integer == null)
              {
                ...
                if (json_rational == null)
                  {
                    throw new Exception("The value for field DirectionDegrees of TypeAvgWindJSON is not a number.");
                  }
                if (!(json_rational.isInteger()))
                  {
                    throw new Exception("The value for field DirectionDegrees of TypeAvgWindJSON is not an integer.");
                  }
                extracted_integer = (short)(json_rational.getLongInt())            ;
              }
            else
        ...
        public virtual int extraTypeAvgWindComponentCount()
          {
            Debug.Assert(extraKeys.Count == extraValues.Count);
            return extraKeys.Count;
          }
        public virtual string extraTypeAvgWindComponentKey(int component_num)
          {
            Debug.Assert(extraKeys.Count == extraValues.Count);
            Debug.Assert(component_num < extraValues.Count);
            return extraKeys[component_num];
          }
        public virtual JSONValue extraTypeAvgWindComponentValue(int component_num)
          {
            Debug.Assert(extraKeys.Count == extraValues.Count);
            Debug.Assert(component_num < extraValues.Count);
            return extraValues[component_num];
          }
        public virtual JSONValue extraTypeAvgWindLookup(string field_name)
          {
            JSONValue result = (extraIndex.ContainsKey(field_name) ? extraIndex[field_name] : null);
            return result;
          }
        ...
        public void setDirectionDegrees(short new_value)
          {
            flagHasDirectionDegrees = true;
            if (new_value < 0)
                throw new Exception("The value for field DirectionDegrees of TypeAvgWindJSON is less than the lower bound (0) for that field.");
            if (new_value > 360)
                throw new Exception("The value for field DirectionDegrees of TypeAvgWindJSON is greater than the upper bound (360) for that field.");
            storeDirectionDegrees = new_value;
          }
        public void unsetDirectionDegrees()
          {
        ...
        public virtual void extraTypeAvgWindAppendPair(string key, JSONValue new_component)
          {
            Debug.Assert(key != null);
            Debug.Assert(new_component != null);
        ...
        public virtual void extraTypeAvgWindSetField(string key, JSONValue new_component)
          {
            Debug.Assert(key != null);
            Debug.Assert(new_component != null);
        ...
        public static TypeAvgWindJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
          {
            TypeAvgWindJSON result;
              {
                HoldingGenerator generator = new HoldingGenerator("Type TypeAvgWind", ignore_extras);
                generator.set_allow_incomplete(allow_incomplete);
                generator.set_allow_unpolished(allow_unpolished);
                if (allow_incomplete || allow_unpolished)
                    json_value.write(generator);
        ...
        public static TypeAvgWindJSON from_json(JSONValue json_value, bool ignore_extras, bool allow_incomplete)
      {
        return from_json(json_value, ignore_extras, allow_incomplete, false);
      }
        public static TypeAvgWindJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete, bool allow_unpolished)
          {
            TypeAvgWindJSON result;
              {
                HoldingGenerator generator = new HoldingGenerator("Type TypeAvgWind", ignore_extras);
        ...
        public static TypeAvgWindJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
      {
        return from_json(json_value, ignore_extras, allow_incomplete, false);
      }
        public static TypeAvgWindJSON from_text(string text, bool ignore_extras)
          {
            TypeAvgWindJSON result;
              {
                HoldingGenerator generator = new HoldingGenerator("Type TypeAvgWind", ignore_extras);
                JSONParse.parse_json_value(text, "Text for TypeAvgWindJSON", generator);
                Debug.Assert(generator.have_value);
                result = generator.value;
              };
            return result;
          }
        public static TypeAvgWindJSON from_file(TextReader fp, string file_name, bool ignore_extras)
          {
            TypeAvgWindJSON result;
              {
                HoldingGenerator generator = new HoldingGenerator("Type TypeAvgWind", ignore_extras);
        ...
        private class FieldHoldingArrayGeneratorDirectionDegrees : JSONHoldingIntegerRangeArrayGenerator
            ...
            protected override void finish()
              {
                ...
                for (int extra_num = 0; extra_num < extra_count; ++extra_num)
                  {
                    result.extraTypeAvgWindAppendPair(unknownFieldGenerator.field_names[extra_num], unknownFieldGenerator.field_values[extra_num]);
                  }
                unknownFieldGenerator.field_names.Clear();
                unknownFieldGenerator.field_values.Clear();
                unknownFieldGenerator.index = new Dictionary<string, JSONValue >();
            ...
            protected void finish(TypeAvgWindJSON result)
              {
                if (fieldGeneratorValue.have_value)
                  {
                    result.setValue(fieldGeneratorValue.value);
            ...
            protected abstract void handle_result(TypeAvgWindJSON new_result);
            protected virtual JSONHandler start_known_field(string field_name)
              {
                switch (field_name[0])
                  {
            ...
            public Generator(bool ignore_extras)
              {
                fieldGeneratorValue = new UnitsValue_WindJSON.HoldingGenerator("field \"Value\" of the TypeAvgWind class", ignore_extras);
                fieldGeneratorDirectionAbbreviation = new JSONHoldingStringGenerator("field \"DirectionAbbreviation\" of the TypeAvgWind class");
                fieldGeneratorDirectionText = new JSONHoldingStringGenerator("field \"DirectionText\" of the TypeAvgWind class");
                fieldGeneratorDirectionDegrees = new FieldHoldingGeneratorDirectionDegrees("field \"DirectionDegrees\" of the TypeAvgWind class");
                unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
            ...
            public Generator()
              {
                fieldGeneratorValue = new UnitsValue_WindJSON.HoldingGenerator("field \"Value\" of the TypeAvgWind class", false);
                fieldGeneratorDirectionAbbreviation = new JSONHoldingStringGenerator("field \"DirectionAbbreviation\" of the TypeAvgWind class");
                fieldGeneratorDirectionText = new JSONHoldingStringGenerator("field \"DirectionText\" of the TypeAvgWind class");
                fieldGeneratorDirectionDegrees = new FieldHoldingGeneratorDirectionDegrees("field \"DirectionDegrees\" of the TypeAvgWind class");
                unknownFieldGenerator = new UnknownFieldGenerator(false);
        ...
        public class HoldingGenerator : Generator
          {
            protected override void handle_result(TypeAvgWindJSON  result)
              {
    //@@@            Debug.Assert(!have_value);
                have_value = true;
                value = result;
        ...
        public class HoldingArrayGenerator : JSONArrayGenerator
      {
        ...
        protected virtual void handle_result(List<TypeAvgWindJSON> result)
        ...
        public HoldingArrayGenerator(string what, bool ignore_extras)
          {
            element_handler = new ElementHandler(this, ignore_extras);
            have_value = false;
            value = new List<TypeAvgWindJSON>();
            base.set_what(what);
          }
        public HoldingArrayGenerator(bool ignore_extras)
          {
        ...
        public bool have_value;
        public List<TypeAvgWindJSON> value;
      };
      };
    ...
    private TypeAvgWindJSON  storeAvgWind;
    private List<string> extraKeys;
    private List<JSONValue > extraValues;
    private Dictionary<string, JSONValue > extraIndex;
    ...
    private void  fromJSONMoonPhaseText(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field MoonPhaseText of DailyForecastJSON is not a string.");
        setMoonPhaseText(json_string.getData());
      }
    ...
    private void  fromJSONForecastShortPhrase(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field ForecastShortPhrase of DailyForecastJSON is not a string.");
        setForecastShortPhrase(json_string.getData());
      }
    ...
    private void  fromJSONAvgWind(JSONValue json_value, bool ignore_extras)
      {
        Debug.Assert(json_value != null);
        TypeAvgWindJSON convert_classy = TypeAvgWindJSON.from_json(json_value, ignore_extras, true);
    ...
    public TypeAvgWindJSON   getAvgWind()
      {
    ...
    public void setMoonPhaseText(string new_value)
      {
    ...
    public void setForecastShortPhrase(string new_value)
      {
    ...
    public void setAvgWind(TypeAvgWindJSON  new_value)
      {
        if (flagHasAvgWind)
          {
          }
    ...
    public static DailyForecastJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    public abstract class Generator : JSONObjectGenerator
      {
        ...
        private JSONHoldingStringGenerator fieldGeneratorMoonPhaseText;
    ...
    private class FieldHoldingArrayGeneratorMoonPhasePct : JSONHoldingIntegerRangeArrayGenerator
        ...
        private JSONHoldingStringGenerator fieldGeneratorForecastShortPhrase;
    ...
    private class FieldHoldingArrayGeneratorMinHumidityPct : JSONHoldingIntegerRangeArrayGenerator
        ...
        private TypeAvgWindJSON.HoldingGenerator fieldGeneratorAvgWind;
        private class UnknownFieldGenerator : JSONValueHandler
          {
            public bool ignore;
            public List<string> field_names;
                        ...
                        switch (field_name[8])
                          {
                            case 'D':
                                ...
                                break;
                            case 'S':
                                if ((String.Compare(field_name, 9, "hortPhrase", 0, 10, false) == 0) && (field_name.Length == 19))
        ...
        public Generator(bool ignore_extras)
          {
            ...
            fieldGeneratorMoonPhaseText = new JSONHoldingStringGenerator("field \"MoonPhaseText\" of the DailyForecast class");
            fieldGeneratorMoonPhasePct = new FieldHoldingGeneratorMoonPhasePct("field \"MoonPhasePct\" of the DailyForecast class");
            fieldGeneratorForecastShortPhrase = new JSONHoldingStringGenerator("field \"ForecastShortPhrase\" of the DailyForecast class");
            ...
            fieldGeneratorMaxWind = new TypeMaxWindJSON.HoldingGenerator("field \"MaxWind\" of the DailyForecast class", ignore_extras);
            fieldGeneratorAvgWind = new TypeAvgWindJSON.HoldingGenerator("field \"AvgWind\" of the DailyForecast class", ignore_extras);
            unknownFieldGenerator = new UnknownFieldGenerator(ignore_extras);
        ...
        public Generator()
          {
            ...
            fieldGeneratorAvgHumidityPct = new FieldHoldingGeneratorAvgHumidityPct("field \"AvgHumidityPct\" of the DailyForecast class");
            fieldGeneratorMinHumidityPct = new FieldHoldingGeneratorMinHumidityPct("field \"MinHumidityPct\" of the DailyForecast class");
            fieldGeneratorMaxWind = new TypeMaxWindJSON.HoldingGenerator("field \"MaxWind\" of the DailyForecast class", false);
            fieldGeneratorAvgWind = new TypeAvgWindJSON.HoldingGenerator("field \"AvgWind\" of the DailyForecast class", false);
            unknownFieldGenerator = new UnknownFieldGenerator(false);
            set_what("the DailyForecast class");
            allow_incomplete = false;
            allow_unpolished = false;
