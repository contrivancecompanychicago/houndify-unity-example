    ...
    private void  fromJSONFormat(JSONValue json_value, bool ignore_extras)
      {
        ...
        if (json_string == null)
            throw new Exception("The value for field Format of UnitsValue_TemperatureJSON is not a string.");
    ...
    private void  fromJSONUnits(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field Units of UnitsValue_TemperatureJSON is not a string.");
    ...
    public static UnitsValue_TemperatureJSON from_json(JSONBase json_value, bool ignore_extras, bool allow_incomplete)
  {
    ...
    private class FieldHoldingArrayGeneratorValue : JSONHoldingIntegerUnboundRangeArrayGenerator
        ...
        public Generator(bool ignore_extras)
          {
            fieldGeneratorFormat = new JSONHoldingStringGenerator("field \"Format\" of the UnitsValue_Temperature class");
            fieldGeneratorUnits = new JSONHoldingStringGenerator("field \"Units\" of the UnitsValue_Temperature class");
