                ...
                switch (chars[1])
                  {
                    case 'l':
                        ...
                        break;
                    case 'r':
                        if ((String.Compare(chars, 2, "chery", 0, 5, false) == 0) && (chars.Length == 7))
                ...
                switch (chars[1])
                  {
                    ...
                    case 'o':
                        ...
                        break;
                    case 'p':
                        if ((String.Compare(chars, 2, "eedSkating", 0, 10, false) == 0) && (chars.Length == 12))
                    ...
                    case 'w':
                        ...
                        break;
                    case 'y':
                        if ((String.Compare(chars, 2, "nchronizedSwimming", 0, 18, false) == 0) && (chars.Length == 20))
                            return TypeValueKnownValues.Value_SynchronizedSwimming;
                        break;
                    default:
                        break;
                  }
        ...
        switch (the_enum)
          {
            ...
            case TypeValueKnownValues.Value_Swimming:
                return "Swimming";
            case TypeValueKnownValues.Value_SynchronizedSwimming:
                ...
                switch (json_string.getData()[1])
                  {
                    case 'l':
                        ...
                        break;
                    case 'r':
                        if ((String.Compare(json_string.getData(), 2, "chery", 0, 5, false) == 0) && (json_string.getData().Length == 7))
                              {
                                the_open_enum.in_known_list = true;
                ...
                switch (json_string.getData()[1])
                  {
                    ...
                    case 'o':
                        ...
                        break;
                    case 'p':
                        if ((String.Compare(json_string.getData(), 2, "eedSkating", 0, 10, false) == 0) && (json_string.getData().Length == 12))
                              {
                                the_open_enum.in_known_list = true;
                    ...
                    case 'w':
                        ...
                        break;
                    case 'y':
                        if ((String.Compare(json_string.getData(), 2, "nchronizedSwimming", 0, 18, false) == 0) && (json_string.getData().Length == 20))
                              {
                                the_open_enum.in_known_list = true;
                                the_open_enum.list_value = TypeValueKnownValues.Value_SynchronizedSwimming;
                                goto open_enum_is_done;
                              }
                        break;
                    default:
