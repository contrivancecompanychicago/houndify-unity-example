        ...
        private void  fromJSONMoonPhaseText(JSONValue json_value, bool ignore_extras)
          {
            ...
            JSONStringValue json_string = json_value.string_value();
            if (json_string == null)
                throw new Exception("The value for field MoonPhaseText of TypeDailySummaryJSON is not a string.");
            ...
            public Generator(bool ignore_extras)
              {
                ...
                fieldGeneratorMoonPhaseText = new JSONHoldingStringGenerator("field \"MoonPhaseText\" of the TypeDailySummary class");
                ...
                fieldGeneratorAvgWind = new TypeAvgWindJSON.HoldingGenerator("field \"AvgWind\" of the TypeDailySummary class", ignore_extras);
            ...
            public Generator()
              {
                ...
                fieldGeneratorAvgWind = new TypeAvgWindJSON.HoldingGenerator("field \"AvgWind\" of the TypeDailySummary class", false);
    ...
    private void  fromJSONRequestedAttribute(JSONValue json_value, bool ignore_extras)
      {
        ...
        JSONStringValue json_string = json_value.string_value();
        if (json_string == null)
            throw new Exception("The value for field RequestedAttribute of ShowWeatherHistoryInformationNuggetJSON is not a string.");
        ...
        public Generator(bool ignore_extras) : base(ignore_extras)
          {
            ...
            fieldGeneratorRequestedAttribute = new JSONHoldingStringGenerator("field \"RequestedAttribute\" of the ShowWeatherHistoryInformationNugget class");
